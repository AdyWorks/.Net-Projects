...
UPDATE pi SET storagepath = '\\arn-nasuni1.ad.ea.com\' FROM processinfo pi WHERE pi.id ='2a769769-1a56-4bd1-a3db-ebcc4e56a4c4';
UPDATE vers SET basepath = REPLACE(basepath, 'ARN-panzura1','arn-nasuni1') FROM vers v WHERE v.id ='2a769769-1a56-4bd1-a3db-ebcc4e56a4c4';
UPDATE format SET path = REPLACE(path COLLATE SQL_Latin1_General_CP1_CI_AS, 'arn-panzura1','arn-nasuni1') FROM format f JOIN hierarchy h ON f.id = h.id WHERE h.parentid ='2a769769-1a56-4bd1-a3db-ebcc4e56a4c4';
...
UPDATE pi SET storagepath = '\\arn-nasuni1.ad.ea.com\' FROM processinfo pi WHERE pi.id ='a628d0b6-2e51-4323-b8c1-b07b780c389d';
UPDATE vers SET basepath = REPLACE(basepath, 'ARN-panzura2','arn-nasuni1') FROM vers v WHERE v.id ='a628d0b6-2e51-4323-b8c1-b07b780c389d';
UPDATE format SET path = REPLACE(path COLLATE SQL_Latin1_General_CP1_CI_AS, 'arn-panzura2','arn-nasuni1') FROM format f JOIN hierarchy h ON f.id = h.id WHERE h.parentid ='a628d0b6-2e51-4323-b8c1-b07b780c389d';
-- Update for version 7622ab29-854c-40c8-a122-7241acbc9035 
UPDATE pi SET storagepath = '\\arn-nasuni1.ad.ea.com\' FROM processinfo pi WHERE pi.id ='7622ab29-854c-40c8-a122-7241acbc9035';
UPDATE vers SET basepath = REPLACE(basepath, 'ARN-panzura1','arn-nasuni1') FROM vers v WHERE v.id ='7622ab29-854c-40c8-a122-7241acbc9035';
UPDATE format SET path = REPLACE(path COLLATE SQL_Latin1_General_CP1_CI_AS, 'arn-panzura1','arn-nasuni1') FROM format f JOIN hierarchy h ON f.id = h.id WHERE h.parentid ='7622ab29-854c-40c8-a122-7241acbc9035';
...
UPDATE pi SET storagepath = '\\arn-nasuni1.ad.ea.com\' FROM processinfo pi WHERE pi.id ='da68e48c-97d7-49c1-b089-bcc420d26c22';
UPDATE vers SET basepath = REPLACE(basepath, 'ARN-panzura2','arn-nasuni1') FROM vers v WHERE v.id ='da68e48c-97d7-49c1-b089-bcc420d26c22';
UPDATE format SET path = REPLACE(path COLLATE SQL_Latin1_General_CP1_CI_AS, 'arn-panzura2','arn-nasuni1') FROM format f JOIN hierarchy h ON f.id = h.id WHERE h.parentid ='da68e48c-97d7-49c1-b089-bcc420d26c22';
-- Update for version 62781431-1137-48f9-b6df-289f49eaf015 
UPDATE pi SET storagepath = '\\arn-nasuni1.ad.ea.com\' FROM processinfo pi WHERE pi.id ='62781431-1137-48f9-b6df-289f49eaf015';
UPDATE vers SET basepath = REPLACE(basepath, 'ARN-panzura2','arn-nasuni1') FROM vers v WHERE v.id ='62781431-1137-48f9-b6df-289f49eaf015';
UPDATE format SET path = REPLACE(path COLLATE SQL_Latin1_General_CP1_CI_AS, 'arn-panzura2','arn-nasuni1') FROM format f JOIN hierarchy h ON f.id = h.id WHERE h.parentid ='62781431-1137-48f9-b6df-289f49eaf015';
-- Update for version a15f7c8d-0788-4218-8a15-9139565e86c0 
UPDATE pi SET storagepath = '\\arn-nasuni1.ad.ea.com\' FROM processinfo pi WHERE pi.id ='a15f7c8d-0788-4218-8a15-9139565e86c0';
UPDATE vers SET basepath = REPLACE(basepath, 'ARN-panzura2','arn-nasuni1') FROM vers v WHERE v.id ='a15f7c8d-0788-4218-8a15-9139565e86c0';
UPDATE format SET path = REPLACE(path COLLATE SQL_Latin1_General_CP1_CI_AS, 'arn-panzura2','arn-nasuni1') FROM format f JOIN hierarchy h ON f.id = h.id WHERE h.parentid ='a15f7c8d-0788-4218-8a15-9139565e86c0';
...
UPDATE pi SET storagepath = '\\arn-nasuni1.ad.ea.com\' FROM processinfo pi WHERE pi.id ='fa77e19e-3fd6-4e7c-afa4-b9bfee14924f';
UPDATE vers SET basepath = REPLACE(basepath, 'ARN-panzura2','arn-nasuni1') FROM vers v WHERE v.id ='fa77e19e-3fd6-4e7c-afa4-b9bfee14924f';
UPDATE format SET path = REPLACE(path COLLATE SQL_Latin1_General_CP1_CI_AS, 'arn-panzura2','arn-nasuni1') FROM format f JOIN hierarchy h ON f.id = h.id WHERE h.parentid ='fa77e19e-3fd6-4e7c-afa4-b9bfee14924f';
-- Update for version 433a8527-ce4c-4b83-a45a-d8d0c8d8264d 
UPDATE pi SET storagepath = '\\arn-nasuni1.ad.ea.com\' FROM processinfo pi WHERE pi.id ='433a8527-ce4c-4b83-a45a-d8d0c8d8264d';
UPDATE vers SET basepath = REPLACE(basepath, 'ARN-panzura2','arn-nasuni1') FROM vers v WHERE v.id ='433a8527-ce4c-4b83-a45a-d8d0c8d8264d';
UPDATE format SET path = REPLACE(path COLLATE SQL_Latin1_General_CP1_CI_AS, 'arn-panzura2','arn-nasuni1') FROM format f JOIN hierarchy h ON f.id = h.id WHERE h.parentid ='433a8527-ce4c-4b83-a45a-d8d0c8d8264d';
-- Update for version fca1c7de-8b04-49db-9a57-e3abaf3b75d3 
UPDATE pi SET storagepath = '\\arn-nasuni1.ad.ea.com\' FROM processinfo pi WHERE pi.id ='fca1c7de-8b04-49db-9a57-e3abaf3b75d3';
UPDATE vers SET basepath = REPLACE(basepath, 'ARN-panzura1','arn-nasuni1') FROM vers v WHERE v.id ='fca1c7de-8b04-49db-9a57-e3abaf3b75d3';
UPDATE format SET path = REPLACE(path COLLATE SQL_Latin1_General_CP1_CI_AS, 'arn-panzura1','arn-nasuni1') FROM format f JOIN hierarchy h ON f.id = h.id WHERE h.parentid ='fca1c7de-8b04-49db-9a57-e3abaf3b75d3';
-- Update for version 246a8d34-fbe9-48db-8bd7-9138313ed4e8 
UPDATE pi SET storagepath = '\\arn-nasuni1.ad.ea.com\' FROM processinfo pi WHERE pi.id ='246a8d34-fbe9-48db-8bd7-9138313ed4e8';
UPDATE vers SET basepath = REPLACE(basepath, 'ARN-panzura1','arn-nasuni1') FROM vers v WHERE v.id ='246a8d34-fbe9-48db-8bd7-9138313ed4e8';
UPDATE format SET path = REPLACE(path COLLATE SQL_Latin1_General_CP1_CI_AS, 'arn-panzura1','arn-nasuni1') FROM format f JOIN hierarchy h ON f.id = h.id WHERE h.parentid ='246a8d34-fbe9-48db-8bd7-9138313ed4e8';
-- Update for version dd97abdd-31d6-4ac3-a34e-78fbc88c9625 
UPDATE pi SET storagepath = '\\arn-nasuni1.ad.ea.com\' FROM processinfo pi WHERE pi.id ='dd97abdd-31d6-4ac3-a34e-78fbc88c9625';
UPDATE vers SET basepath = REPLACE(basepath, 'ARN-panzura1','arn-nasuni1') FROM vers v WHERE v.id ='dd97abdd-31d6-4ac3-a34e-78fbc88c9625';
UPDATE format SET path = REPLACE(path COLLATE SQL_Latin1_General_CP1_CI_AS, 'arn-panzura1','arn-nasuni1') FROM format f JOIN hierarchy h ON f.id = h.id WHERE h.parentid ='dd97abdd-31d6-4ac3-a34e-78fbc88c9625';
-- Update for version 7cf8f755-5f90-42a1-b0ce-4a6094e9b271 
UPDATE pi SET storagepath = '\\arn-nasuni1.ad.ea.com\' FROM processinfo pi WHERE pi.id ='7cf8f755-5f90-42a1-b0ce-4a6094e9b271';
UPDATE vers SET basepath = REPLACE(basepath, 'ARN-panzura1','arn-nasuni1') FROM vers v WHERE v.id ='7cf8f755-5f90-42a1-b0ce-4a6094e9b271';
UPDATE format SET path = REPLACE(path COLLATE SQL_Latin1_General_CP1_CI_AS, 'arn-panzura1','arn-nasuni1') FROM format f JOIN hierarchy h ON f.id = h.id WHERE h.parentid ='7cf8f755-5f90-42a1-b0ce-4a6094e9b271';
-- Update for version a31aedbe-1db6-4952-a07f-612d2609e0c0 
UPDATE pi SET storagepath = '\\arn-nasuni1.ad.ea.com\' FROM processinfo pi WHERE pi.id ='a31aedbe-1db6-4952-a07f-612d2609e0c0';
UPDATE vers SET basepath = REPLACE(basepath, 'ARN-panzura1','arn-nasuni1') FROM vers v WHERE v.id ='a31aedbe-1db6-4952-a07f-612d2609e0c0';
UPDATE format SET path = REPLACE(path COLLATE SQL_Latin1_General_CP1_CI_AS, 'arn-panzura1','arn-nasuni1') FROM format f JOIN hierarchy h ON f.id = h.id WHERE h.parentid ='a31aedbe-1db6-4952-a07f-612d2609e0c0';
-- Update for version 6c84fab9-8317-4f6d-9e62-25bdde208459 
UPDATE pi SET storagepath = '\\arn-nasuni1.ad.ea.com\' FROM processinfo pi WHERE pi.id ='6c84fab9-8317-4f6d-9e62-25bdde208459';
UPDATE vers SET basepath = REPLACE(basepath, 'ARN-panzura1','arn-nasuni1') FROM vers v WHERE v.id ='6c84fab9-8317-4f6d-9e62-25bdde208459';
UPDATE format SET path = REPLACE(path COLLATE SQL_Latin1_General_CP1_CI_AS, 'arn-panzura1','arn-nasuni1') FROM format f JOIN hierarchy h ON f.id = h.id WHERE h.parentid ='6c84fab9-8317-4f6d-9e62-25bdde208459';
-- Update for version 7ce99598-feb6-4870-bc8c-32bf1200a6f5 
UPDATE pi SET storagepath = '\\arn-nasuni1.ad.ea.com\' FROM processinfo pi WHERE pi.id ='7ce99598-feb6-4870-bc8c-32bf1200a6f5';
UPDATE vers SET basepath = REPLACE(basepath, 'ARN-panzura1','arn-nasuni1') FROM vers v WHERE v.id ='7ce99598-feb6-4870-bc8c-32bf1200a6f5';
UPDATE format SET path = REPLACE(path COLLATE SQL_Latin1_General_CP1_CI_AS, 'arn-panzura1','arn-nasuni1') FROM format f JOIN hierarchy h ON f.id = h.id WHERE h.parentid ='7ce99598-feb6-4870-bc8c-32bf1200a6f5';
-- Update for version 84ccc2fc-9a3d-43e4-86b2-3f7c0f548b29 
UPDATE pi SET storagepath = '\\arn-nasuni1.ad.ea.com\' FROM processinfo pi WHERE pi.id ='84ccc2fc-9a3d-43e4-86b2-3f7c0f548b29';
UPDATE vers SET basepath = REPLACE(basepath, 'ARN-panzura1','arn-nasuni1') FROM vers v WHERE v.id ='84ccc2fc-9a3d-43e4-86b2-3f7c0f548b29';
UPDATE format SET path = REPLACE(path COLLATE SQL_Latin1_General_CP1_CI_AS, 'arn-panzura1','arn-nasuni1') FROM format f JOIN hierarchy h ON f.id = h.id WHERE h.parentid ='84ccc2fc-9a3d-43e4-86b2-3f7c0f548b29';
-- Update for version 81f39206-50d3-488d-b232-c96a3aaf3046 
UPDATE pi SET storagepath = '\\arn-nasuni1.ad.ea.com\' FROM processinfo pi WHERE pi.id ='81f39206-50d3-488d-b232-c96a3aaf3046';
UPDATE vers SET basepath = REPLACE(basepath, 'ARN-panzura2','arn-nasuni1') FROM vers v WHERE v.id ='81f39206-50d3-488d-b232-c96a3aaf3046';
UPDATE format SET path = REPLACE(path COLLATE SQL_Latin1_General_CP1_CI_AS, 'arn-panzura2','arn-nasuni1') FROM format f JOIN hierarchy h ON f.id = h.id WHERE h.parentid ='81f39206-50d3-488d-b232-c96a3aaf3046';
...
UPDATE pi SET storagepath = '\\arn-nasuni1.ad.ea.com\' FROM processinfo pi WHERE pi.id ='aca0c15f-43d0-4070-9f8a-27a28a744a56';
UPDATE vers SET basepath = REPLACE(basepath, 'ARN-panzura1','arn-nasuni1') FROM vers v WHERE v.id ='aca0c15f-43d0-4070-9f8a-27a28a744a56';
UPDATE format SET path = REPLACE(path COLLATE SQL_Latin1_General_CP1_CI_AS, 'arn-panzura1','arn-nasuni1') FROM format f JOIN hierarchy h ON f.id = h.id WHERE h.parentid ='aca0c15f-43d0-4070-9f8a-27a28a744a56';
-- Update for version d1c38cab-4279-4ecf-8586-3399a51d3dbc 
UPDATE pi SET storagepath = '\\arn-nasuni1.ad.ea.com\' FROM processinfo pi WHERE pi.id ='d1c38cab-4279-4ecf-8586-3399a51d3dbc';
UPDATE vers SET basepath = REPLACE(basepath, 'ARN-panzura1','arn-nasuni1') FROM vers v WHERE v.id ='d1c38cab-4279-4ecf-8586-3399a51d3dbc';
UPDATE format SET path = REPLACE(path COLLATE SQL_Latin1_General_CP1_CI_AS, 'arn-panzura1','arn-nasuni1') FROM format f JOIN hierarchy h ON f.id = h.id WHERE h.parentid ='d1c38cab-4279-4ecf-8586-3399a51d3dbc';
-- Update for version 0b8e18cf-1ff2-428a-8323-4dab0d15515f 
UPDATE pi SET storagepath = '\\arn-nasuni1.ad.ea.com\' FROM processinfo pi WHERE pi.id ='0b8e18cf-1ff2-428a-8323-4dab0d15515f';
UPDATE vers SET basepath = REPLACE(basepath, 'ARN-panzura1','arn-nasuni1') FROM vers v WHERE v.id ='0b8e18cf-1ff2-428a-8323-4dab0d15515f';
UPDATE format SET path = REPLACE(path COLLATE SQL_Latin1_General_CP1_CI_AS, 'arn-panzura1','arn-nasuni1') FROM format f JOIN hierarchy h ON f.id = h.id WHERE h.parentid ='0b8e18cf-1ff2-428a-8323-4dab0d15515f';
-- Update for version a5f8e833-20b5-44ad-972e-f5b4da5386a4 
UPDATE pi SET storagepath = '\\arn-nasuni1.ad.ea.com\' FROM processinfo pi WHERE pi.id ='a5f8e833-20b5-44ad-972e-f5b4da5386a4';
UPDATE vers SET basepath = REPLACE(basepath, 'ARN-panzura1','arn-nasuni1') FROM vers v WHERE v.id ='a5f8e833-20b5-44ad-972e-f5b4da5386a4';
UPDATE format SET path = REPLACE(path COLLATE SQL_Latin1_General_CP1_CI_AS, 'arn-panzura1','arn-nasuni1') FROM format f JOIN hierarchy h ON f.id = h.id WHERE h.parentid ='a5f8e833-20b5-44ad-972e-f5b4da5386a4';
-- Update for version b77eca3e-fb7b-4be3-8211-6d72c10535d2 
UPDATE pi SET storagepath = '\\arn-nasuni1.ad.ea.com\' FROM processinfo pi WHERE pi.id ='b77eca3e-fb7b-4be3-8211-6d72c10535d2';
UPDATE vers SET basepath = REPLACE(basepath, 'ARN-panzura1','arn-nasuni1') FROM vers v WHERE v.id ='b77eca3e-fb7b-4be3-8211-6d72c10535d2';
UPDATE format SET path = REPLACE(path COLLATE SQL_Latin1_General_CP1_CI_AS, 'arn-panzura1','arn-nasuni1') FROM format f JOIN hierarchy h ON f.id = h.id WHERE h.parentid ='b77eca3e-fb7b-4be3-8211-6d72c10535d2';
-- Update for version 69aa6984-0b62-4cc4-acc4-0281ec0f4a63 
UPDATE pi SET storagepath = '\\arn-nasuni1.ad.ea.com\' FROM processinfo pi WHERE pi.id ='69aa6984-0b62-4cc4-acc4-0281ec0f4a63';
UPDATE vers SET basepath = REPLACE(basepath, 'ARN-panzura1','arn-nasuni1') FROM vers v WHERE v.id ='69aa6984-0b62-4cc4-acc4-0281ec0f4a63';
UPDATE format SET path = REPLACE(path COLLATE SQL_Latin1_General_CP1_CI_AS, 'arn-panzura1','arn-nasuni1') FROM format f JOIN hierarchy h ON f.id = h.id WHERE h.parentid ='69aa6984-0b62-4cc4-acc4-0281ec0f4a63';
-- Update for version 3b57361c-4f7a-4122-bb53-c1224a60c15d 
UPDATE pi SET storagepath = '\\arn-nasuni1.ad.ea.com\' FROM processinfo pi WHERE pi.id ='3b57361c-4f7a-4122-bb53-c1224a60c15d';
UPDATE vers SET basepath = REPLACE(basepath, 'ARN-panzura1','arn-nasuni1') FROM vers v WHERE v.id ='3b57361c-4f7a-4122-bb53-c1224a60c15d';
UPDATE format SET path = REPLACE(path COLLATE SQL_Latin1_General_CP1_CI_AS, 'arn-panzura1','arn-nasuni1') FROM format f JOIN hierarchy h ON f.id = h.id WHERE h.parentid ='3b57361c-4f7a-4122-bb53-c1224a60c15d';
-- Update for version 7d37bf6c-83ad-45f8-a21c-745057988e12 
UPDATE pi SET storagepath = '\\arn-nasuni1.ad.ea.com\' FROM processinfo pi WHERE pi.id ='7d37bf6c-83ad-45f8-a21c-745057988e12';
UPDATE vers SET basepath = REPLACE(basepath, 'ARN-panzura1','arn-nasuni1') FROM vers v WHERE v.id ='7d37bf6c-83ad-45f8-a21c-745057988e12';
UPDATE format SET path = REPLACE(path COLLATE SQL_Latin1_General_CP1_CI_AS, 'arn-panzura1','arn-nasuni1') FROM format f JOIN hierarchy h ON f.id = h.id WHERE h.parentid ='7d37bf6c-83ad-45f8-a21c-745057988e12';
-- Update for version 4682a844-4a2b-437f-bb9e-38bce634b243 
UPDATE pi SET storagepath = '\\arn-nasuni1.ad.ea.com\' FROM processinfo pi WHERE pi.id ='4682a844-4a2b-437f-bb9e-38bce634b243';
UPDATE vers SET basepath = REPLACE(basepath, 'ARN-panzura1','arn-nasuni1') FROM vers v WHERE v.id ='4682a844-4a2b-437f-bb9e-38bce634b243';
UPDATE format SET path = REPLACE(path COLLATE SQL_Latin1_General_CP1_CI_AS, 'arn-panzura1','arn-nasuni1') FROM format f JOIN hierarchy h ON f.id = h.id WHERE h.parentid ='4682a844-4a2b-437f-bb9e-38bce634b243';
-- Update for version 3a39e8e9-46cf-4ac6-8173-c50c74a9dfd6 
UPDATE pi SET storagepath = '\\arn-nasuni1.ad.ea.com\' FROM processinfo pi WHERE pi.id ='3a39e8e9-46cf-4ac6-8173-c50c74a9dfd6';
UPDATE vers SET basepath = REPLACE(basepath, 'ARN-panzura1','arn-nasuni1') FROM vers v WHERE v.id ='3a39e8e9-46cf-4ac6-8173-c50c74a9dfd6';
UPDATE format SET path = REPLACE(path COLLATE SQL_Latin1_General_CP1_CI_AS, 'arn-panzura1','arn-nasuni1') FROM format f JOIN hierarchy h ON f.id = h.id WHERE h.parentid ='3a39e8e9-46cf-4ac6-8173-c50c74a9dfd6';
-- Update for version 28765ef4-7279-48ea-a515-4122a3bfc60b 
UPDATE pi SET storagepath = '\\arn-nasuni1.ad.ea.com\' FROM processinfo pi WHERE pi.id ='28765ef4-7279-48ea-a515-4122a3bfc60b';
UPDATE vers SET basepath = REPLACE(basepath, 'ARN-panzura1','arn-nasuni1') FROM vers v WHERE v.id ='28765ef4-7279-48ea-a515-4122a3bfc60b';
UPDATE format SET path = REPLACE(path COLLATE SQL_Latin1_General_CP1_CI_AS, 'arn-panzura1','arn-nasuni1') FROM format f JOIN hierarchy h ON f.id = h.id WHERE h.parentid ='28765ef4-7279-48ea-a515-4122a3bfc60b';
-- Update for version e7fa60c5-4dec-4da2-84d3-a6edbde68934 
UPDATE pi SET storagepath = '\\arn-nasuni1.ad.ea.com\' FROM processinfo pi WHERE pi.id ='e7fa60c5-4dec-4da2-84d3-a6edbde68934';
UPDATE vers SET basepath = REPLACE(basepath, 'ARN-panzura1','arn-nasuni1') FROM vers v WHERE v.id ='e7fa60c5-4dec-4da2-84d3-a6edbde68934';
UPDATE format SET path = REPLACE(path COLLATE SQL_Latin1_General_CP1_CI_AS, 'arn-panzura1','arn-nasuni1') FROM format f JOIN hierarchy h ON f.id = h.id WHERE h.parentid ='e7fa60c5-4dec-4da2-84d3-a6edbde68934';
-- Update for version a7060192-f06b-43a4-813f-d8be7ffe00b9 
UPDATE pi SET storagepath = '\\arn-nasuni1.ad.ea.com\' FROM processinfo pi WHERE pi.id ='a7060192-f06b-43a4-813f-d8be7ffe00b9';
UPDATE vers SET basepath = REPLACE(basepath, 'ARN-panzura1','arn-nasuni1') FROM vers v WHERE v.id ='a7060192-f06b-43a4-813f-d8be7ffe00b9';
UPDATE format SET path = REPLACE(path COLLATE SQL_Latin1_General_CP1_CI_AS, 'arn-panzura1','arn-nasuni1') FROM format f JOIN hierarchy h ON f.id = h.id WHERE h.parentid ='a7060192-f06b-43a4-813f-d8be7ffe00b9';
-- Update for version e2dd7c5b-f430-4995-8c5a-2abb63d63583 
UPDATE pi SET storagepath = '\\arn-nasuni1.ad.ea.com\' FROM processinfo pi WHERE pi.id ='e2dd7c5b-f430-4995-8c5a-2abb63d63583';
UPDATE vers SET basepath = REPLACE(basepath, 'ARN-panzura1','arn-nasuni1') FROM vers v WHERE v.id ='e2dd7c5b-f430-4995-8c5a-2abb63d63583';
UPDATE format SET path = REPLACE(path COLLATE SQL_Latin1_General_CP1_CI_AS, 'arn-panzura1','arn-nasuni1') FROM format f JOIN hierarchy h ON f.id = h.id WHERE h.parentid ='e2dd7c5b-f430-4995-8c5a-2abb63d63583';
...
UPDATE pi SET storagepath = '\\arn-nasuni1.ad.ea.com\' FROM processinfo pi WHERE pi.id ='c659d0a8-ae63-4db4-8bb3-c25e7c56702a';
UPDATE vers SET basepath = REPLACE(basepath, 'ARN-panzura1','arn-nasuni1') FROM vers v WHERE v.id ='c659d0a8-ae63-4db4-8bb3-c25e7c56702a';
UPDATE format SET path = REPLACE(path COLLATE SQL_Latin1_General_CP1_CI_AS, 'arn-panzura1','arn-nasuni1') FROM format f JOIN hierarchy h ON f.id = h.id WHERE h.parentid ='c659d0a8-ae63-4db4-8bb3-c25e7c56702a';
-- Update for version 0c3f6e1a-21d5-4362-b290-c9cbef8f110c 
UPDATE pi SET storagepath = '\\arn-nasuni1.ad.ea.com\' FROM processinfo pi WHERE pi.id ='0c3f6e1a-21d5-4362-b290-c9cbef8f110c';
UPDATE vers SET basepath = REPLACE(basepath, 'ARN-panzura1','arn-nasuni1') FROM vers v WHERE v.id ='0c3f6e1a-21d5-4362-b290-c9cbef8f110c';
UPDATE format SET path = REPLACE(path COLLATE SQL_Latin1_General_CP1_CI_AS, 'arn-panzura1','arn-nasuni1') FROM format f JOIN hierarchy h ON f.id = h.id WHERE h.parentid ='0c3f6e1a-21d5-4362-b290-c9cbef8f110c';
-- Update for version d84305e5-337f-4c1f-b08a-3c6a25d767f4 
UPDATE pi SET storagepath = '\\arn-nasuni1.ad.ea.com\' FROM processinfo pi WHERE pi.id ='d84305e5-337f-4c1f-b08a-3c6a25d767f4';
UPDATE vers SET basepath = REPLACE(basepath, 'ARN-panzura1','arn-nasuni1') FROM vers v WHERE v.id ='d84305e5-337f-4c1f-b08a-3c6a25d767f4';
UPDATE format SET path = REPLACE(path COLLATE SQL_Latin1_General_CP1_CI_AS, 'arn-panzura1','arn-nasuni1') FROM format f JOIN hierarchy h ON f.id = h.id WHERE h.parentid ='d84305e5-337f-4c1f-b08a-3c6a25d767f4';
...
UPDATE pi SET storagepath = '\\arn-nasuni1.ad.ea.com\' FROM processinfo pi WHERE pi.id ='84c6336e-a91e-4322-8d38-00258da5ec9b';
UPDATE vers SET basepath = REPLACE(basepath, 'ARN-panzura2','arn-nasuni1') FROM vers v WHERE v.id ='84c6336e-a91e-4322-8d38-00258da5ec9b';
UPDATE format SET path = REPLACE(path COLLATE SQL_Latin1_General_CP1_CI_AS, 'arn-panzura2','arn-nasuni1') FROM format f JOIN hierarchy h ON f.id = h.id WHERE h.parentid ='84c6336e-a91e-4322-8d38-00258da5ec9b';
...
UPDATE pi SET storagepath = '\\arn-nasuni1.ad.ea.com\' FROM processinfo pi WHERE pi.id ='ae50b845-b158-4498-a34f-804cb042d363';
UPDATE vers SET basepath = REPLACE(basepath, 'ARN-panzura1','arn-nasuni1') FROM vers v WHERE v.id ='ae50b845-b158-4498-a34f-804cb042d363';
UPDATE format SET path = REPLACE(path COLLATE SQL_Latin1_General_CP1_CI_AS, 'arn-panzura1','arn-nasuni1') FROM format f JOIN hierarchy h ON f.id = h.id WHERE h.parentid ='ae50b845-b158-4498-a34f-804cb042d363';
...
UPDATE pi SET storagepath = '\\arn-nasuni1.ad.ea.com\' FROM processinfo pi WHERE pi.id ='fdc200c2-bdcf-4e89-991f-187716a2802a';
UPDATE vers SET basepath = REPLACE(basepath, 'ARN-panzura1','arn-nasuni1') FROM vers v WHERE v.id ='fdc200c2-bdcf-4e89-991f-187716a2802a';
UPDATE format SET path = REPLACE(path COLLATE SQL_Latin1_General_CP1_CI_AS, 'arn-panzura1','arn-nasuni1') FROM format f JOIN hierarchy h ON f.id = h.id WHERE h.parentid ='fdc200c2-bdcf-4e89-991f-187716a2802a';
...
UPDATE pi SET storagepath = '\\arn-nasuni1.ad.ea.com\' FROM processinfo pi WHERE pi.id ='02cd318d-df80-4935-a350-d88b6c102dec';
UPDATE vers SET basepath = REPLACE(basepath, 'ARN-panzura1','arn-nasuni1') FROM vers v WHERE v.id ='02cd318d-df80-4935-a350-d88b6c102dec';
UPDATE format SET path = REPLACE(path COLLATE SQL_Latin1_General_CP1_CI_AS, 'arn-panzura1','arn-nasuni1') FROM format f JOIN hierarchy h ON f.id = h.id WHERE h.parentid ='02cd318d-df80-4935-a350-d88b6c102dec';
...
UPDATE pi SET storagepath = '\\arn-nasuni1.ad.ea.com\' FROM processinfo pi WHERE pi.id ='667347ef-85e0-4b21-8f6d-209d3f4fe2fb';
UPDATE vers SET basepath = REPLACE(basepath, 'ARN-panzura1','arn-nasuni1') FROM vers v WHERE v.id ='667347ef-85e0-4b21-8f6d-209d3f4fe2fb';
UPDATE format SET path = REPLACE(path COLLATE SQL_Latin1_General_CP1_CI_AS, 'arn-panzura1','arn-nasuni1') FROM format f JOIN hierarchy h ON f.id = h.id WHERE h.parentid ='667347ef-85e0-4b21-8f6d-209d3f4fe2fb';
...
UPDATE pi SET storagepath = '\\arn-nasuni1.ad.ea.com\' FROM processinfo pi WHERE pi.id ='6a5cae64-b3c6-4dd0-98a5-d372da5df674';
UPDATE vers SET basepath = REPLACE(basepath, 'ARN-panzura1','arn-nasuni1') FROM vers v WHERE v.id ='6a5cae64-b3c6-4dd0-98a5-d372da5df674';
UPDATE format SET path = REPLACE(path COLLATE SQL_Latin1_General_CP1_CI_AS, 'arn-panzura1','arn-nasuni1') FROM format f JOIN hierarchy h ON f.id = h.id WHERE h.parentid ='6a5cae64-b3c6-4dd0-98a5-d372da5df674';
...
UPDATE pi SET storagepath = '\\arn-nasuni1.ad.ea.com\' FROM processinfo pi WHERE pi.id ='d6deb90a-4e0c-4b2f-b6ff-ef3170cf6903';
UPDATE vers SET basepath = REPLACE(basepath, 'ARN-panzura1','arn-nasuni1') FROM vers v WHERE v.id ='d6deb90a-4e0c-4b2f-b6ff-ef3170cf6903';
UPDATE format SET path = REPLACE(path COLLATE SQL_Latin1_General_CP1_CI_AS, 'arn-panzura1','arn-nasuni1') FROM format f JOIN hierarchy h ON f.id = h.id WHERE h.parentid ='d6deb90a-4e0c-4b2f-b6ff-ef3170cf6903';
-- Update for version d277fa69-a440-4053-b236-00e40024520d 
UPDATE pi SET storagepath = '\\arn-nasuni1.ad.ea.com\' FROM processinfo pi WHERE pi.id ='d277fa69-a440-4053-b236-00e40024520d';
UPDATE vers SET basepath = REPLACE(basepath, 'ARN-panzura1','arn-nasuni1') FROM vers v WHERE v.id ='d277fa69-a440-4053-b236-00e40024520d';
UPDATE format SET path = REPLACE(path COLLATE SQL_Latin1_General_CP1_CI_AS, 'arn-panzura1','arn-nasuni1') FROM format f JOIN hierarchy h ON f.id = h.id WHERE h.parentid ='d277fa69-a440-4053-b236-00e40024520d';
-- Update for version dca7338f-930c-4732-a49a-94e68c4141aa 
UPDATE pi SET storagepath = '\\arn-nasuni1.ad.ea.com\' FROM processinfo pi WHERE pi.id ='dca7338f-930c-4732-a49a-94e68c4141aa';
UPDATE vers SET basepath = REPLACE(basepath, 'ARN-panzura1','arn-nasuni1') FROM vers v WHERE v.id ='dca7338f-930c-4732-a49a-94e68c4141aa';
UPDATE format SET path = REPLACE(path COLLATE SQL_Latin1_General_CP1_CI_AS, 'arn-panzura1','arn-nasuni1') FROM format f JOIN hierarchy h ON f.id = h.id WHERE h.parentid ='dca7338f-930c-4732-a49a-94e68c4141aa';
-- Update for version b07e4f80-2066-4981-b6d7-8b2c218385c1 
UPDATE pi SET storagepath = '\\arn-nasuni1.ad.ea.com\' FROM processinfo pi WHERE pi.id ='b07e4f80-2066-4981-b6d7-8b2c218385c1';
UPDATE vers SET basepath = REPLACE(basepath, 'ARN-panzura2','arn-nasuni1') FROM vers v WHERE v.id ='b07e4f80-2066-4981-b6d7-8b2c218385c1';
UPDATE format SET path = REPLACE(path COLLATE SQL_Latin1_General_CP1_CI_AS, 'arn-panzura2','arn-nasuni1') FROM format f JOIN hierarchy h ON f.id = h.id WHERE h.parentid ='b07e4f80-2066-4981-b6d7-8b2c218385c1';
-- Update for version 1b886f6b-f99d-4412-944b-3ff0aad1de28 
UPDATE pi SET storagepath = '\\arn-nasuni1.ad.ea.com\' FROM processinfo pi WHERE pi.id ='1b886f6b-f99d-4412-944b-3ff0aad1de28';
UPDATE vers SET basepath = REPLACE(basepath, 'ARN-panzura2','arn-nasuni1') FROM vers v WHERE v.id ='1b886f6b-f99d-4412-944b-3ff0aad1de28';
UPDATE format SET path = REPLACE(path COLLATE SQL_Latin1_General_CP1_CI_AS, 'arn-panzura2','arn-nasuni1') FROM format f JOIN hierarchy h ON f.id = h.id WHERE h.parentid ='1b886f6b-f99d-4412-944b-3ff0aad1de28';
...
UPDATE pi SET storagepath = '\\arn-nasuni1.ad.ea.com\' FROM processinfo pi WHERE pi.id ='e8d51a21-af74-4837-98df-8baa8ea777d3';
UPDATE vers SET basepath = REPLACE(basepath, 'ARN-panzura2','arn-nasuni1') FROM vers v WHERE v.id ='e8d51a21-af74-4837-98df-8baa8ea777d3';
UPDATE format SET path = REPLACE(path COLLATE SQL_Latin1_General_CP1_CI_AS, 'arn-panzura2','arn-nasuni1') FROM format f JOIN hierarchy h ON f.id = h.id WHERE h.parentid ='e8d51a21-af74-4837-98df-8baa8ea777d3';
-- Update for version 99fdf392-d7ca-4129-ac21-5b5dba4583ba 
UPDATE pi SET storagepath = '\\arn-nasuni1.ad.ea.com\' FROM processinfo pi WHERE pi.id ='99fdf392-d7ca-4129-ac21-5b5dba4583ba';
UPDATE vers SET basepath = REPLACE(basepath, 'ARN-panzura2','arn-nasuni1') FROM vers v WHERE v.id ='99fdf392-d7ca-4129-ac21-5b5dba4583ba';
UPDATE format SET path = REPLACE(path COLLATE SQL_Latin1_General_CP1_CI_AS, 'arn-panzura2','arn-nasuni1') FROM format f JOIN hierarchy h ON f.id = h.id WHERE h.parentid ='99fdf392-d7ca-4129-ac21-5b5dba4583ba';
-- Update for version 867bb3e7-f21c-496e-a0c3-1c325ea21ae3 
UPDATE pi SET storagepath = '\\arn-nasuni1.ad.ea.com\' FROM processinfo pi WHERE pi.id ='867bb3e7-f21c-496e-a0c3-1c325ea21ae3';
UPDATE vers SET basepath = REPLACE(basepath, 'ARN-panzura2','arn-nasuni1') FROM vers v WHERE v.id ='867bb3e7-f21c-496e-a0c3-1c325ea21ae3';
UPDATE format SET path = REPLACE(path COLLATE SQL_Latin1_General_CP1_CI_AS, 'arn-panzura2','arn-nasuni1') FROM format f JOIN hierarchy h ON f.id = h.id WHERE h.parentid ='867bb3e7-f21c-496e-a0c3-1c325ea21ae3';
...
UPDATE pi SET storagepath = '\\arn-nasuni1.ad.ea.com\' FROM processinfo pi WHERE pi.id ='8357c945-8725-47ab-9fc9-10b0ab4589b5';
UPDATE vers SET basepath = REPLACE(basepath, 'ARN-panzura2','arn-nasuni1') FROM vers v WHERE v.id ='8357c945-8725-47ab-9fc9-10b0ab4589b5';
UPDATE format SET path = REPLACE(path COLLATE SQL_Latin1_General_CP1_CI_AS, 'arn-panzura2','arn-nasuni1') FROM format f JOIN hierarchy h ON f.id = h.id WHERE h.parentid ='8357c945-8725-47ab-9fc9-10b0ab4589b5';
...
UPDATE pi SET storagepath = '\\arn-nasuni1.ad.ea.com\' FROM processinfo pi WHERE pi.id ='987cc45c-3d3a-45c2-84a9-fb91987ce975';
UPDATE vers SET basepath = REPLACE(basepath, 'ARN-panzura1','arn-nasuni1') FROM vers v WHERE v.id ='987cc45c-3d3a-45c2-84a9-fb91987ce975';
UPDATE format SET path = REPLACE(path COLLATE SQL_Latin1_General_CP1_CI_AS, 'arn-panzura1','arn-nasuni1') FROM format f JOIN hierarchy h ON f.id = h.id WHERE h.parentid ='987cc45c-3d3a-45c2-84a9-fb91987ce975';
-- Update for version f1e38166-3327-4fe1-b3fc-c17c6efbb3fe 
UPDATE pi SET storagepath = '\\arn-nasuni1.ad.ea.com\' FROM processinfo pi WHERE pi.id ='f1e38166-3327-4fe1-b3fc-c17c6efbb3fe';
UPDATE vers SET basepath = REPLACE(basepath, 'ARN-panzura1','arn-nasuni1') FROM vers v WHERE v.id ='f1e38166-3327-4fe1-b3fc-c17c6efbb3fe';
UPDATE format SET path = REPLACE(path COLLATE SQL_Latin1_General_CP1_CI_AS, 'arn-panzura1','arn-nasuni1') FROM format f JOIN hierarchy h ON f.id = h.id WHERE h.parentid ='f1e38166-3327-4fe1-b3fc-c17c6efbb3fe';
...
UPDATE pi SET storagepath = '\\arn-nasuni1.ad.ea.com\' FROM processinfo pi WHERE pi.id ='33da2e7f-7c6a-41f0-a515-d3621cfe5e9f';
UPDATE vers SET basepath = REPLACE(basepath, 'ARN-panzura2','arn-nasuni1') FROM vers v WHERE v.id ='33da2e7f-7c6a-41f0-a515-d3621cfe5e9f';
UPDATE format SET path = REPLACE(path COLLATE SQL_Latin1_General_CP1_CI_AS, 'arn-panzura2','arn-nasuni1') FROM format f JOIN hierarchy h ON f.id = h.id WHERE h.parentid ='33da2e7f-7c6a-41f0-a515-d3621cfe5e9f';
-- Update for version c65f6a67-d622-4f51-88be-4cd01663d91b 
UPDATE pi SET storagepath = '\\arn-nasuni1.ad.ea.com\' FROM processinfo pi WHERE pi.id ='c65f6a67-d622-4f51-88be-4cd01663d91b';
UPDATE vers SET basepath = REPLACE(basepath, 'ARN-panzura2','arn-nasuni1') FROM vers v WHERE v.id ='c65f6a67-d622-4f51-88be-4cd01663d91b';
UPDATE format SET path = REPLACE(path COLLATE SQL_Latin1_General_CP1_CI_AS, 'arn-panzura2','arn-nasuni1') FROM format f JOIN hierarchy h ON f.id = h.id WHERE h.parentid ='c65f6a67-d622-4f51-88be-4cd01663d91b';
-- Update for version 2891958a-31ca-4593-b1b0-72110480181d 
UPDATE pi SET storagepath = '\\arn-nasuni1.ad.ea.com\' FROM processinfo pi WHERE pi.id ='2891958a-31ca-4593-b1b0-72110480181d';
UPDATE vers SET basepath = REPLACE(basepath, 'ARN-panzura2','arn-nasuni1') FROM vers v WHERE v.id ='2891958a-31ca-4593-b1b0-72110480181d';
UPDATE format SET path = REPLACE(path COLLATE SQL_Latin1_General_CP1_CI_AS, 'arn-panzura2','arn-nasuni1') FROM format f JOIN hierarchy h ON f.id = h.id WHERE h.parentid ='2891958a-31ca-4593-b1b0-72110480181d';
-- Update for version 281bb9ea-ad0b-4d51-906d-9d68fd3a689b 
UPDATE pi SET storagepath = '\\arn-nasuni1.ad.ea.com\' FROM processinfo pi WHERE pi.id ='281bb9ea-ad0b-4d51-906d-9d68fd3a689b';
UPDATE vers SET basepath = REPLACE(basepath, 'ARN-panzura2','arn-nasuni1') FROM vers v WHERE v.id ='281bb9ea-ad0b-4d51-906d-9d68fd3a689b';
UPDATE format SET path = REPLACE(path COLLATE SQL_Latin1_General_CP1_CI_AS, 'arn-panzura2','arn-nasuni1') FROM format f JOIN hierarchy h ON f.id = h.id WHERE h.parentid ='281bb9ea-ad0b-4d51-906d-9d68fd3a689b';
...
UPDATE pi SET storagepath = '\\arn-nasuni1.ad.ea.com\' FROM processinfo pi WHERE pi.id ='e5221d5a-d49e-46db-8260-9125c7d6b27d';
UPDATE vers SET basepath = REPLACE(basepath, 'ARN-panzura2','arn-nasuni1') FROM vers v WHERE v.id ='e5221d5a-d49e-46db-8260-9125c7d6b27d';
UPDATE format SET path = REPLACE(path COLLATE SQL_Latin1_General_CP1_CI_AS, 'arn-panzura2','arn-nasuni1') FROM format f JOIN hierarchy h ON f.id = h.id WHERE h.parentid ='e5221d5a-d49e-46db-8260-9125c7d6b27d';
-- Update for version 34f03888-5e13-4ca6-8ebd-8b28d1392222 
UPDATE pi SET storagepath = '\\arn-nasuni1.ad.ea.com\' FROM processinfo pi WHERE pi.id ='34f03888-5e13-4ca6-8ebd-8b28d1392222';
UPDATE vers SET basepath = REPLACE(basepath, 'ARN-panzura2','arn-nasuni1') FROM vers v WHERE v.id ='34f03888-5e13-4ca6-8ebd-8b28d1392222';
UPDATE format SET path = REPLACE(path COLLATE SQL_Latin1_General_CP1_CI_AS, 'arn-panzura2','arn-nasuni1') FROM format f JOIN hierarchy h ON f.id = h.id WHERE h.parentid ='34f03888-5e13-4ca6-8ebd-8b28d1392222';
-- Update for version 58044276-ad63-4bfe-b571-b0d92daa5991 
UPDATE pi SET storagepath = '\\arn-nasuni1.ad.ea.com\' FROM processinfo pi WHERE pi.id ='58044276-ad63-4bfe-b571-b0d92daa5991';
UPDATE vers SET basepath = REPLACE(basepath, 'ARN-panzura2','arn-nasuni1') FROM vers v WHERE v.id ='58044276-ad63-4bfe-b571-b0d92daa5991';
UPDATE format SET path = REPLACE(path COLLATE SQL_Latin1_General_CP1_CI_AS, 'arn-panzura2','arn-nasuni1') FROM format f JOIN hierarchy h ON f.id = h.id WHERE h.parentid ='58044276-ad63-4bfe-b571-b0d92daa5991';
...
UPDATE pi SET storagepath = '\\arn-nasuni1.ad.ea.com\' FROM processinfo pi WHERE pi.id ='9b1555e5-3e85-4547-bdcc-e0a68d789b61';
UPDATE vers SET basepath = REPLACE(basepath, 'ARN-panzura1','arn-nasuni1') FROM vers v WHERE v.id ='9b1555e5-3e85-4547-bdcc-e0a68d789b61';
UPDATE format SET path = REPLACE(path COLLATE SQL_Latin1_General_CP1_CI_AS, 'arn-panzura1','arn-nasuni1') FROM format f JOIN hierarchy h ON f.id = h.id WHERE h.parentid ='9b1555e5-3e85-4547-bdcc-e0a68d789b61';
-- Update for version 5c00b1c7-1101-4f45-8e92-bb622ea60b17 
UPDATE pi SET storagepath = '\\arn-nasuni1.ad.ea.com\' FROM processinfo pi WHERE pi.id ='5c00b1c7-1101-4f45-8e92-bb622ea60b17';
UPDATE vers SET basepath = REPLACE(basepath, 'ARN-panzura1','arn-nasuni1') FROM vers v WHERE v.id ='5c00b1c7-1101-4f45-8e92-bb622ea60b17';
UPDATE format SET path = REPLACE(path COLLATE SQL_Latin1_General_CP1_CI_AS, 'arn-panzura1','arn-nasuni1') FROM format f JOIN hierarchy h ON f.id = h.id WHERE h.parentid ='5c00b1c7-1101-4f45-8e92-bb622ea60b17';
...
UPDATE pi SET storagepath = '\\arn-nasuni1.ad.ea.com\' FROM processinfo pi WHERE pi.id ='dde3b414-7913-4f26-9daa-6b15fd7c86ae';
UPDATE vers SET basepath = REPLACE(basepath, 'ARN-panzura1','arn-nasuni1') FROM vers v WHERE v.id ='dde3b414-7913-4f26-9daa-6b15fd7c86ae';
UPDATE format SET path = REPLACE(path COLLATE SQL_Latin1_General_CP1_CI_AS, 'arn-panzura1','arn-nasuni1') FROM format f JOIN hierarchy h ON f.id = h.id WHERE h.parentid ='dde3b414-7913-4f26-9daa-6b15fd7c86ae';
...
UPDATE pi SET storagepath = '\\arn-nasuni1.ad.ea.com\' FROM processinfo pi WHERE pi.id ='d46c7923-eac0-4a84-ad86-570ec0b74be4';
UPDATE vers SET basepath = REPLACE(basepath, 'ARN-panzura1','arn-nasuni1') FROM vers v WHERE v.id ='d46c7923-eac0-4a84-ad86-570ec0b74be4';
UPDATE format SET path = REPLACE(path COLLATE SQL_Latin1_General_CP1_CI_AS, 'arn-panzura1','arn-nasuni1') FROM format f JOIN hierarchy h ON f.id = h.id WHERE h.parentid ='d46c7923-eac0-4a84-ad86-570ec0b74be4';
-- Update for version d5d53baa-676e-4cd1-86cf-fca6e0167f84 
UPDATE pi SET storagepath = '\\arn-nasuni1.ad.ea.com\' FROM processinfo pi WHERE pi.id ='d5d53baa-676e-4cd1-86cf-fca6e0167f84';
UPDATE vers SET basepath = REPLACE(basepath, 'ARN-panzura1','arn-nasuni1') FROM vers v WHERE v.id ='d5d53baa-676e-4cd1-86cf-fca6e0167f84';
UPDATE format SET path = REPLACE(path COLLATE SQL_Latin1_General_CP1_CI_AS, 'arn-panzura1','arn-nasuni1') FROM format f JOIN hierarchy h ON f.id = h.id WHERE h.parentid ='d5d53baa-676e-4cd1-86cf-fca6e0167f84';
-- Update for version 091dd753-f299-4481-b814-0c216e478a6a 
UPDATE pi SET storagepath = '\\arn-nasuni1.ad.ea.com\' FROM processinfo pi WHERE pi.id ='091dd753-f299-4481-b814-0c216e478a6a';
UPDATE vers SET basepath = REPLACE(basepath, 'ARN-panzura1','arn-nasuni1') FROM vers v WHERE v.id ='091dd753-f299-4481-b814-0c216e478a6a';
UPDATE format SET path = REPLACE(path COLLATE SQL_Latin1_General_CP1_CI_AS, 'arn-panzura1','arn-nasuni1') FROM format f JOIN hierarchy h ON f.id = h.id WHERE h.parentid ='091dd753-f299-4481-b814-0c216e478a6a';
...
UPDATE pi SET storagepath = '\\arn-nasuni1.ad.ea.com\' FROM processinfo pi WHERE pi.id ='9e749acc-6bd2-44ef-812f-b407aa858121';
UPDATE vers SET basepath = REPLACE(basepath, 'ARN-panzura1','arn-nasuni1') FROM vers v WHERE v.id ='9e749acc-6bd2-44ef-812f-b407aa858121';
UPDATE format SET path = REPLACE(path COLLATE SQL_Latin1_General_CP1_CI_AS, 'arn-panzura1','arn-nasuni1') FROM format f JOIN hierarchy h ON f.id = h.id WHERE h.parentid ='9e749acc-6bd2-44ef-812f-b407aa858121';
-- Update for version cfeb2caf-8319-4e9f-8ca2-a33664bca5e8 
UPDATE pi SET storagepath = '\\arn-nasuni1.ad.ea.com\' FROM processinfo pi WHERE pi.id ='cfeb2caf-8319-4e9f-8ca2-a33664bca5e8';
UPDATE vers SET basepath = REPLACE(basepath, 'ARN-panzura1','arn-nasuni1') FROM vers v WHERE v.id ='cfeb2caf-8319-4e9f-8ca2-a33664bca5e8';
UPDATE format SET path = REPLACE(path COLLATE SQL_Latin1_General_CP1_CI_AS, 'arn-panzura1','arn-nasuni1') FROM format f JOIN hierarchy h ON f.id = h.id WHERE h.parentid ='cfeb2caf-8319-4e9f-8ca2-a33664bca5e8';
...
UPDATE pi SET storagepath = '\\arn-nasuni1.ad.ea.com\' FROM processinfo pi WHERE pi.id ='85822dd9-0f8d-4c6b-972f-e25c84fe172b';
UPDATE vers SET basepath = REPLACE(basepath, 'ARN-panzura1','arn-nasuni1') FROM vers v WHERE v.id ='85822dd9-0f8d-4c6b-972f-e25c84fe172b';
UPDATE format SET path = REPLACE(path COLLATE SQL_Latin1_General_CP1_CI_AS, 'arn-panzura1','arn-nasuni1') FROM format f JOIN hierarchy h ON f.id = h.id WHERE h.parentid ='85822dd9-0f8d-4c6b-972f-e25c84fe172b';
-- Update for version b7eb098b-b1f7-4e2a-bf90-eae1bd0e5626 
UPDATE pi SET storagepath = '\\arn-nasuni1.ad.ea.com\' FROM processinfo pi WHERE pi.id ='b7eb098b-b1f7-4e2a-bf90-eae1bd0e5626';
UPDATE vers SET basepath = REPLACE(basepath, 'ARN-panzura1','arn-nasuni1') FROM vers v WHERE v.id ='b7eb098b-b1f7-4e2a-bf90-eae1bd0e5626';
UPDATE format SET path = REPLACE(path COLLATE SQL_Latin1_General_CP1_CI_AS, 'arn-panzura1','arn-nasuni1') FROM format f JOIN hierarchy h ON f.id = h.id WHERE h.parentid ='b7eb098b-b1f7-4e2a-bf90-eae1bd0e5626';
-- Update for version 8fa1a1f1-b212-496e-8f81-a55929695f5b 
UPDATE pi SET storagepath = '\\arn-nasuni1.ad.ea.com\' FROM processinfo pi WHERE pi.id ='8fa1a1f1-b212-496e-8f81-a55929695f5b';
UPDATE vers SET basepath = REPLACE(basepath, 'ARN-panzura1','arn-nasuni1') FROM vers v WHERE v.id ='8fa1a1f1-b212-496e-8f81-a55929695f5b';
UPDATE format SET path = REPLACE(path COLLATE SQL_Latin1_General_CP1_CI_AS, 'arn-panzura1','arn-nasuni1') FROM format f JOIN hierarchy h ON f.id = h.id WHERE h.parentid ='8fa1a1f1-b212-496e-8f81-a55929695f5b';
-- Update for version 949783bf-1162-4617-a2be-e31c57ad7e04 
UPDATE pi SET storagepath = '\\arn-nasuni1.ad.ea.com\' FROM processinfo pi WHERE pi.id ='949783bf-1162-4617-a2be-e31c57ad7e04';
UPDATE vers SET basepath = REPLACE(basepath, 'ARN-panzura1','arn-nasuni1') FROM vers v WHERE v.id ='949783bf-1162-4617-a2be-e31c57ad7e04';
UPDATE format SET path = REPLACE(path COLLATE SQL_Latin1_General_CP1_CI_AS, 'arn-panzura1','arn-nasuni1') FROM format f JOIN hierarchy h ON f.id = h.id WHERE h.parentid ='949783bf-1162-4617-a2be-e31c57ad7e04';
