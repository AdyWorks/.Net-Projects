...
UPDATE pi SET storagepath = '\\arn-nasuni1.ad.ea.com\' FROM processinfo pi WHERE pi.id ='df91d12b-c2d9-493c-ade8-634a27c0c70b';
UPDATE vers SET basepath = REPLACE(basepath, 'ARN-panzura2','arn-nasuni1') FROM vers v WHERE v.id ='df91d12b-c2d9-493c-ade8-634a27c0c70b';
UPDATE format SET path = REPLACE(path COLLATE SQL_Latin1_General_CP1_CI_AS, 'arn-panzura2','arn-nasuni1') FROM format f JOIN hierarchy h ON f.id = h.id WHERE h.parentid ='df91d12b-c2d9-493c-ade8-634a27c0c70b';
-- Update for version f2e224f3-ae16-4814-864a-243a3f821f71 
UPDATE pi SET storagepath = '\\arn-nasuni1.ad.ea.com\' FROM processinfo pi WHERE pi.id ='f2e224f3-ae16-4814-864a-243a3f821f71';
UPDATE vers SET basepath = REPLACE(basepath, 'ARN-panzura2','arn-nasuni1') FROM vers v WHERE v.id ='f2e224f3-ae16-4814-864a-243a3f821f71';
UPDATE format SET path = REPLACE(path COLLATE SQL_Latin1_General_CP1_CI_AS, 'arn-panzura2','arn-nasuni1') FROM format f JOIN hierarchy h ON f.id = h.id WHERE h.parentid ='f2e224f3-ae16-4814-864a-243a3f821f71';
...
UPDATE pi SET storagepath = '\\arn-nasuni1.ad.ea.com\' FROM processinfo pi WHERE pi.id ='4428530a-c0df-405e-b860-ce565ba2433d';
UPDATE vers SET basepath = REPLACE(basepath, 'ARN-panzura1','arn-nasuni1') FROM vers v WHERE v.id ='4428530a-c0df-405e-b860-ce565ba2433d';
UPDATE format SET path = REPLACE(path COLLATE SQL_Latin1_General_CP1_CI_AS, 'arn-panzura1','arn-nasuni1') FROM format f JOIN hierarchy h ON f.id = h.id WHERE h.parentid ='4428530a-c0df-405e-b860-ce565ba2433d';
-- Update for version a439df82-8843-4ea1-b38e-956814a386ba 
UPDATE pi SET storagepath = '\\arn-nasuni1.ad.ea.com\' FROM processinfo pi WHERE pi.id ='a439df82-8843-4ea1-b38e-956814a386ba';
UPDATE vers SET basepath = REPLACE(basepath, 'ARN-panzura1','arn-nasuni1') FROM vers v WHERE v.id ='a439df82-8843-4ea1-b38e-956814a386ba';
UPDATE format SET path = REPLACE(path COLLATE SQL_Latin1_General_CP1_CI_AS, 'arn-panzura1','arn-nasuni1') FROM format f JOIN hierarchy h ON f.id = h.id WHERE h.parentid ='a439df82-8843-4ea1-b38e-956814a386ba';
...
UPDATE pi SET storagepath = '\\arn-nasuni1.ad.ea.com\' FROM processinfo pi WHERE pi.id ='9d786970-7e4c-48f8-8d63-486f4c38da9a';
UPDATE vers SET basepath = REPLACE(basepath, 'ARN-panzura1','arn-nasuni1') FROM vers v WHERE v.id ='9d786970-7e4c-48f8-8d63-486f4c38da9a';
UPDATE format SET path = REPLACE(path COLLATE SQL_Latin1_General_CP1_CI_AS, 'arn-panzura1','arn-nasuni1') FROM format f JOIN hierarchy h ON f.id = h.id WHERE h.parentid ='9d786970-7e4c-48f8-8d63-486f4c38da9a';
-- Update for version 3aa067f3-28f0-4be1-827b-e4b5d3de189c 
UPDATE pi SET storagepath = '\\arn-nasuni1.ad.ea.com\' FROM processinfo pi WHERE pi.id ='3aa067f3-28f0-4be1-827b-e4b5d3de189c';
UPDATE vers SET basepath = REPLACE(basepath, 'ARN-panzura1','arn-nasuni1') FROM vers v WHERE v.id ='3aa067f3-28f0-4be1-827b-e4b5d3de189c';
UPDATE format SET path = REPLACE(path COLLATE SQL_Latin1_General_CP1_CI_AS, 'arn-panzura1','arn-nasuni1') FROM format f JOIN hierarchy h ON f.id = h.id WHERE h.parentid ='3aa067f3-28f0-4be1-827b-e4b5d3de189c';
-- Update for version a70391e6-519a-4fb8-97a4-06306f0aa1f8 
UPDATE pi SET storagepath = '\\arn-nasuni1.ad.ea.com\' FROM processinfo pi WHERE pi.id ='a70391e6-519a-4fb8-97a4-06306f0aa1f8';
UPDATE vers SET basepath = REPLACE(basepath, 'ARN-panzura1','arn-nasuni1') FROM vers v WHERE v.id ='a70391e6-519a-4fb8-97a4-06306f0aa1f8';
UPDATE format SET path = REPLACE(path COLLATE SQL_Latin1_General_CP1_CI_AS, 'arn-panzura1','arn-nasuni1') FROM format f JOIN hierarchy h ON f.id = h.id WHERE h.parentid ='a70391e6-519a-4fb8-97a4-06306f0aa1f8';
-- Update for version 44717362-38ba-4476-9f79-2e8a766494e5 
UPDATE pi SET storagepath = '\\arn-nasuni1.ad.ea.com\' FROM processinfo pi WHERE pi.id ='44717362-38ba-4476-9f79-2e8a766494e5';
UPDATE vers SET basepath = REPLACE(basepath, 'ARN-panzura1','arn-nasuni1') FROM vers v WHERE v.id ='44717362-38ba-4476-9f79-2e8a766494e5';
UPDATE format SET path = REPLACE(path COLLATE SQL_Latin1_General_CP1_CI_AS, 'arn-panzura1','arn-nasuni1') FROM format f JOIN hierarchy h ON f.id = h.id WHERE h.parentid ='44717362-38ba-4476-9f79-2e8a766494e5';
-- Update for version ab47fa41-f4bb-41bc-aac7-f322256f5679 
UPDATE pi SET storagepath = '\\arn-nasuni1.ad.ea.com\' FROM processinfo pi WHERE pi.id ='ab47fa41-f4bb-41bc-aac7-f322256f5679';
UPDATE vers SET basepath = REPLACE(basepath, 'ARN-panzura1','arn-nasuni1') FROM vers v WHERE v.id ='ab47fa41-f4bb-41bc-aac7-f322256f5679';
UPDATE format SET path = REPLACE(path COLLATE SQL_Latin1_General_CP1_CI_AS, 'arn-panzura1','arn-nasuni1') FROM format f JOIN hierarchy h ON f.id = h.id WHERE h.parentid ='ab47fa41-f4bb-41bc-aac7-f322256f5679';
-- Update for version f98e4b4a-b0bf-47d0-a2d4-14171aca9cae 
UPDATE pi SET storagepath = '\\arn-nasuni1.ad.ea.com\' FROM processinfo pi WHERE pi.id ='f98e4b4a-b0bf-47d0-a2d4-14171aca9cae';
UPDATE vers SET basepath = REPLACE(basepath, 'ARN-panzura1','arn-nasuni1') FROM vers v WHERE v.id ='f98e4b4a-b0bf-47d0-a2d4-14171aca9cae';
UPDATE format SET path = REPLACE(path COLLATE SQL_Latin1_General_CP1_CI_AS, 'arn-panzura1','arn-nasuni1') FROM format f JOIN hierarchy h ON f.id = h.id WHERE h.parentid ='f98e4b4a-b0bf-47d0-a2d4-14171aca9cae';
-- Update for version 472a8916-2379-41ae-a102-122bc27708d3 
UPDATE pi SET storagepath = '\\arn-nasuni1.ad.ea.com\' FROM processinfo pi WHERE pi.id ='472a8916-2379-41ae-a102-122bc27708d3';
UPDATE vers SET basepath = REPLACE(basepath, 'ARN-panzura1','arn-nasuni1') FROM vers v WHERE v.id ='472a8916-2379-41ae-a102-122bc27708d3';
UPDATE format SET path = REPLACE(path COLLATE SQL_Latin1_General_CP1_CI_AS, 'arn-panzura1','arn-nasuni1') FROM format f JOIN hierarchy h ON f.id = h.id WHERE h.parentid ='472a8916-2379-41ae-a102-122bc27708d3';
-- Update for version a23698e9-be86-477a-a637-98c0a2eaf976 
UPDATE pi SET storagepath = '\\arn-nasuni1.ad.ea.com\' FROM processinfo pi WHERE pi.id ='a23698e9-be86-477a-a637-98c0a2eaf976';
UPDATE vers SET basepath = REPLACE(basepath, 'ARN-panzura1','arn-nasuni1') FROM vers v WHERE v.id ='a23698e9-be86-477a-a637-98c0a2eaf976';
UPDATE format SET path = REPLACE(path COLLATE SQL_Latin1_General_CP1_CI_AS, 'arn-panzura1','arn-nasuni1') FROM format f JOIN hierarchy h ON f.id = h.id WHERE h.parentid ='a23698e9-be86-477a-a637-98c0a2eaf976';
-- Update for version a37b5977-36fd-44a4-a746-668c109aee4b 
UPDATE pi SET storagepath = '\\arn-nasuni1.ad.ea.com\' FROM processinfo pi WHERE pi.id ='a37b5977-36fd-44a4-a746-668c109aee4b';
UPDATE vers SET basepath = REPLACE(basepath, 'ARN-panzura1','arn-nasuni1') FROM vers v WHERE v.id ='a37b5977-36fd-44a4-a746-668c109aee4b';
UPDATE format SET path = REPLACE(path COLLATE SQL_Latin1_General_CP1_CI_AS, 'arn-panzura1','arn-nasuni1') FROM format f JOIN hierarchy h ON f.id = h.id WHERE h.parentid ='a37b5977-36fd-44a4-a746-668c109aee4b';
-- Update for version 5332a35d-0080-4c95-9a2c-f230c990b71a 
UPDATE pi SET storagepath = '\\arn-nasuni1.ad.ea.com\' FROM processinfo pi WHERE pi.id ='5332a35d-0080-4c95-9a2c-f230c990b71a';
UPDATE vers SET basepath = REPLACE(basepath, 'ARN-panzura1','arn-nasuni1') FROM vers v WHERE v.id ='5332a35d-0080-4c95-9a2c-f230c990b71a';
UPDATE format SET path = REPLACE(path COLLATE SQL_Latin1_General_CP1_CI_AS, 'arn-panzura1','arn-nasuni1') FROM format f JOIN hierarchy h ON f.id = h.id WHERE h.parentid ='5332a35d-0080-4c95-9a2c-f230c990b71a';
-- Update for version 08a89537-959b-4a8b-a49e-b5dabb971f26 
UPDATE pi SET storagepath = '\\arn-nasuni1.ad.ea.com\' FROM processinfo pi WHERE pi.id ='08a89537-959b-4a8b-a49e-b5dabb971f26';
UPDATE vers SET basepath = REPLACE(basepath, 'ARN-panzura1','arn-nasuni1') FROM vers v WHERE v.id ='08a89537-959b-4a8b-a49e-b5dabb971f26';
UPDATE format SET path = REPLACE(path COLLATE SQL_Latin1_General_CP1_CI_AS, 'arn-panzura1','arn-nasuni1') FROM format f JOIN hierarchy h ON f.id = h.id WHERE h.parentid ='08a89537-959b-4a8b-a49e-b5dabb971f26';
...
UPDATE pi SET storagepath = '\\arn-nasuni1.ad.ea.com\' FROM processinfo pi WHERE pi.id ='4a7af47a-0bd2-472e-9fd3-da2a9a66b25f';
UPDATE vers SET basepath = REPLACE(basepath, 'ARN-panzura1','arn-nasuni1') FROM vers v WHERE v.id ='4a7af47a-0bd2-472e-9fd3-da2a9a66b25f';
UPDATE format SET path = REPLACE(path COLLATE SQL_Latin1_General_CP1_CI_AS, 'arn-panzura1','arn-nasuni1') FROM format f JOIN hierarchy h ON f.id = h.id WHERE h.parentid ='4a7af47a-0bd2-472e-9fd3-da2a9a66b25f';
-- Update for version 33c9db19-d9f6-46bf-a787-53005205aeb9 
UPDATE pi SET storagepath = '\\arn-nasuni1.ad.ea.com\' FROM processinfo pi WHERE pi.id ='33c9db19-d9f6-46bf-a787-53005205aeb9';
UPDATE vers SET basepath = REPLACE(basepath, 'ARN-panzura1','arn-nasuni1') FROM vers v WHERE v.id ='33c9db19-d9f6-46bf-a787-53005205aeb9';
UPDATE format SET path = REPLACE(path COLLATE SQL_Latin1_General_CP1_CI_AS, 'arn-panzura1','arn-nasuni1') FROM format f JOIN hierarchy h ON f.id = h.id WHERE h.parentid ='33c9db19-d9f6-46bf-a787-53005205aeb9';
-- Update for version 02189f3a-2928-492c-a8bb-4ce98e71a5a4 
UPDATE pi SET storagepath = '\\arn-nasuni1.ad.ea.com\' FROM processinfo pi WHERE pi.id ='02189f3a-2928-492c-a8bb-4ce98e71a5a4';
UPDATE vers SET basepath = REPLACE(basepath, 'ARN-panzura1','arn-nasuni1') FROM vers v WHERE v.id ='02189f3a-2928-492c-a8bb-4ce98e71a5a4';
UPDATE format SET path = REPLACE(path COLLATE SQL_Latin1_General_CP1_CI_AS, 'arn-panzura1','arn-nasuni1') FROM format f JOIN hierarchy h ON f.id = h.id WHERE h.parentid ='02189f3a-2928-492c-a8bb-4ce98e71a5a4';
-- Update for version 48a42e42-f30b-435d-b8a3-96f399e4ac75 
UPDATE pi SET storagepath = '\\arn-nasuni1.ad.ea.com\' FROM processinfo pi WHERE pi.id ='48a42e42-f30b-435d-b8a3-96f399e4ac75';
UPDATE vers SET basepath = REPLACE(basepath, 'ARN-panzura1','arn-nasuni1') FROM vers v WHERE v.id ='48a42e42-f30b-435d-b8a3-96f399e4ac75';
UPDATE format SET path = REPLACE(path COLLATE SQL_Latin1_General_CP1_CI_AS, 'arn-panzura1','arn-nasuni1') FROM format f JOIN hierarchy h ON f.id = h.id WHERE h.parentid ='48a42e42-f30b-435d-b8a3-96f399e4ac75';
-- Update for version 9661d1c4-ec6b-4664-83ff-dac29def2ec2 
UPDATE pi SET storagepath = '\\arn-nasuni1.ad.ea.com\' FROM processinfo pi WHERE pi.id ='9661d1c4-ec6b-4664-83ff-dac29def2ec2';
UPDATE vers SET basepath = REPLACE(basepath, 'ARN-panzura1','arn-nasuni1') FROM vers v WHERE v.id ='9661d1c4-ec6b-4664-83ff-dac29def2ec2';
UPDATE format SET path = REPLACE(path COLLATE SQL_Latin1_General_CP1_CI_AS, 'arn-panzura1','arn-nasuni1') FROM format f JOIN hierarchy h ON f.id = h.id WHERE h.parentid ='9661d1c4-ec6b-4664-83ff-dac29def2ec2';
-- Update for version af319e0b-91c6-44fa-8e76-59dfe3f7e6ca 
UPDATE pi SET storagepath = '\\arn-nasuni1.ad.ea.com\' FROM processinfo pi WHERE pi.id ='af319e0b-91c6-44fa-8e76-59dfe3f7e6ca';
UPDATE vers SET basepath = REPLACE(basepath, 'ARN-panzura1','arn-nasuni1') FROM vers v WHERE v.id ='af319e0b-91c6-44fa-8e76-59dfe3f7e6ca';
UPDATE format SET path = REPLACE(path COLLATE SQL_Latin1_General_CP1_CI_AS, 'arn-panzura1','arn-nasuni1') FROM format f JOIN hierarchy h ON f.id = h.id WHERE h.parentid ='af319e0b-91c6-44fa-8e76-59dfe3f7e6ca';
...
UPDATE pi SET storagepath = '\\arn-nasuni1.ad.ea.com\' FROM processinfo pi WHERE pi.id ='09437596-418f-4d48-97fb-8d60e2041917';
UPDATE vers SET basepath = REPLACE(basepath, 'ARN-panzura1','arn-nasuni1') FROM vers v WHERE v.id ='09437596-418f-4d48-97fb-8d60e2041917';
UPDATE format SET path = REPLACE(path COLLATE SQL_Latin1_General_CP1_CI_AS, 'arn-panzura1','arn-nasuni1') FROM format f JOIN hierarchy h ON f.id = h.id WHERE h.parentid ='09437596-418f-4d48-97fb-8d60e2041917';
...
UPDATE pi SET storagepath = '\\arn-nasuni1.ad.ea.com\' FROM processinfo pi WHERE pi.id ='4cc11450-a038-4a87-bb3d-3f3a1fc6cddd';
UPDATE vers SET basepath = REPLACE(basepath, 'ARN-panzura1','arn-nasuni1') FROM vers v WHERE v.id ='4cc11450-a038-4a87-bb3d-3f3a1fc6cddd';
UPDATE format SET path = REPLACE(path COLLATE SQL_Latin1_General_CP1_CI_AS, 'arn-panzura1','arn-nasuni1') FROM format f JOIN hierarchy h ON f.id = h.id WHERE h.parentid ='4cc11450-a038-4a87-bb3d-3f3a1fc6cddd';
-- Update for version 4ac7914b-0ee9-48b4-bb55-963917590e11 
UPDATE pi SET storagepath = '\\arn-nasuni1.ad.ea.com\' FROM processinfo pi WHERE pi.id ='4ac7914b-0ee9-48b4-bb55-963917590e11';
UPDATE vers SET basepath = REPLACE(basepath, 'ARN-panzura1','arn-nasuni1') FROM vers v WHERE v.id ='4ac7914b-0ee9-48b4-bb55-963917590e11';
UPDATE format SET path = REPLACE(path COLLATE SQL_Latin1_General_CP1_CI_AS, 'arn-panzura1','arn-nasuni1') FROM format f JOIN hierarchy h ON f.id = h.id WHERE h.parentid ='4ac7914b-0ee9-48b4-bb55-963917590e11';
-- Update for version f8c828ae-99e6-4b48-b53e-883407f2c255 
UPDATE pi SET storagepath = '\\arn-nasuni1.ad.ea.com\' FROM processinfo pi WHERE pi.id ='f8c828ae-99e6-4b48-b53e-883407f2c255';
UPDATE vers SET basepath = REPLACE(basepath, 'ARN-panzura1','arn-nasuni1') FROM vers v WHERE v.id ='f8c828ae-99e6-4b48-b53e-883407f2c255';
UPDATE format SET path = REPLACE(path COLLATE SQL_Latin1_General_CP1_CI_AS, 'arn-panzura1','arn-nasuni1') FROM format f JOIN hierarchy h ON f.id = h.id WHERE h.parentid ='f8c828ae-99e6-4b48-b53e-883407f2c255';
-- Update for version fe06849f-5b17-4e46-a320-6e431f37c016 
UPDATE pi SET storagepath = '\\arn-nasuni1.ad.ea.com\' FROM processinfo pi WHERE pi.id ='fe06849f-5b17-4e46-a320-6e431f37c016';
UPDATE vers SET basepath = REPLACE(basepath, 'ARN-panzura1','arn-nasuni1') FROM vers v WHERE v.id ='fe06849f-5b17-4e46-a320-6e431f37c016';
UPDATE format SET path = REPLACE(path COLLATE SQL_Latin1_General_CP1_CI_AS, 'arn-panzura1','arn-nasuni1') FROM format f JOIN hierarchy h ON f.id = h.id WHERE h.parentid ='fe06849f-5b17-4e46-a320-6e431f37c016';
-- Update for version 52e62a19-1fcb-43ef-8e8d-3c185312adf1 
UPDATE pi SET storagepath = '\\arn-nasuni1.ad.ea.com\' FROM processinfo pi WHERE pi.id ='52e62a19-1fcb-43ef-8e8d-3c185312adf1';
UPDATE vers SET basepath = REPLACE(basepath, 'ARN-panzura1','arn-nasuni1') FROM vers v WHERE v.id ='52e62a19-1fcb-43ef-8e8d-3c185312adf1';
UPDATE format SET path = REPLACE(path COLLATE SQL_Latin1_General_CP1_CI_AS, 'arn-panzura1','arn-nasuni1') FROM format f JOIN hierarchy h ON f.id = h.id WHERE h.parentid ='52e62a19-1fcb-43ef-8e8d-3c185312adf1';
-- Update for version 25977cfc-108e-4d91-9f9f-f4ce7bd48eb7 
UPDATE pi SET storagepath = '\\arn-nasuni1.ad.ea.com\' FROM processinfo pi WHERE pi.id ='25977cfc-108e-4d91-9f9f-f4ce7bd48eb7';
UPDATE vers SET basepath = REPLACE(basepath, 'ARN-panzura2','arn-nasuni1') FROM vers v WHERE v.id ='25977cfc-108e-4d91-9f9f-f4ce7bd48eb7';
UPDATE format SET path = REPLACE(path COLLATE SQL_Latin1_General_CP1_CI_AS, 'arn-panzura2','arn-nasuni1') FROM format f JOIN hierarchy h ON f.id = h.id WHERE h.parentid ='25977cfc-108e-4d91-9f9f-f4ce7bd48eb7';
-- Update for version 37113a5a-a406-45d7-b6ed-61f117764a07 
UPDATE pi SET storagepath = '\\arn-nasuni1.ad.ea.com\' FROM processinfo pi WHERE pi.id ='37113a5a-a406-45d7-b6ed-61f117764a07';
UPDATE vers SET basepath = REPLACE(basepath, 'ARN-panzura2','arn-nasuni1') FROM vers v WHERE v.id ='37113a5a-a406-45d7-b6ed-61f117764a07';
UPDATE format SET path = REPLACE(path COLLATE SQL_Latin1_General_CP1_CI_AS, 'arn-panzura2','arn-nasuni1') FROM format f JOIN hierarchy h ON f.id = h.id WHERE h.parentid ='37113a5a-a406-45d7-b6ed-61f117764a07';
-- Update for version 8002e322-a9e1-4a14-8392-d7fec06c4f87 
UPDATE pi SET storagepath = '\\arn-nasuni1.ad.ea.com\' FROM processinfo pi WHERE pi.id ='8002e322-a9e1-4a14-8392-d7fec06c4f87';
UPDATE vers SET basepath = REPLACE(basepath, 'ARN-panzura2','arn-nasuni1') FROM vers v WHERE v.id ='8002e322-a9e1-4a14-8392-d7fec06c4f87';
UPDATE format SET path = REPLACE(path COLLATE SQL_Latin1_General_CP1_CI_AS, 'arn-panzura2','arn-nasuni1') FROM format f JOIN hierarchy h ON f.id = h.id WHERE h.parentid ='8002e322-a9e1-4a14-8392-d7fec06c4f87';
-- Update for version 00df87f6-f896-428e-9332-f9951b6c2c61 
UPDATE pi SET storagepath = '\\arn-nasuni1.ad.ea.com\' FROM processinfo pi WHERE pi.id ='00df87f6-f896-428e-9332-f9951b6c2c61';
UPDATE vers SET basepath = REPLACE(basepath, 'ARN-panzura2','arn-nasuni1') FROM vers v WHERE v.id ='00df87f6-f896-428e-9332-f9951b6c2c61';
UPDATE format SET path = REPLACE(path COLLATE SQL_Latin1_General_CP1_CI_AS, 'arn-panzura2','arn-nasuni1') FROM format f JOIN hierarchy h ON f.id = h.id WHERE h.parentid ='00df87f6-f896-428e-9332-f9951b6c2c61';
-- Update for version 4bad2cc0-14fd-4a9e-a282-0c3eb078370f 
UPDATE pi SET storagepath = '\\arn-nasuni1.ad.ea.com\' FROM processinfo pi WHERE pi.id ='4bad2cc0-14fd-4a9e-a282-0c3eb078370f';
UPDATE vers SET basepath = REPLACE(basepath, 'ARN-panzura2','arn-nasuni1') FROM vers v WHERE v.id ='4bad2cc0-14fd-4a9e-a282-0c3eb078370f';
UPDATE format SET path = REPLACE(path COLLATE SQL_Latin1_General_CP1_CI_AS, 'arn-panzura2','arn-nasuni1') FROM format f JOIN hierarchy h ON f.id = h.id WHERE h.parentid ='4bad2cc0-14fd-4a9e-a282-0c3eb078370f';
-- Update for version b4a06836-789a-4e89-8c1f-1db5abe07563 
UPDATE pi SET storagepath = '\\arn-nasuni1.ad.ea.com\' FROM processinfo pi WHERE pi.id ='b4a06836-789a-4e89-8c1f-1db5abe07563';
UPDATE vers SET basepath = REPLACE(basepath, 'ARN-panzura2','arn-nasuni1') FROM vers v WHERE v.id ='b4a06836-789a-4e89-8c1f-1db5abe07563';
UPDATE format SET path = REPLACE(path COLLATE SQL_Latin1_General_CP1_CI_AS, 'arn-panzura2','arn-nasuni1') FROM format f JOIN hierarchy h ON f.id = h.id WHERE h.parentid ='b4a06836-789a-4e89-8c1f-1db5abe07563';
-- Update for version 390fac8b-0685-4501-b75e-c2668779d409 
UPDATE pi SET storagepath = '\\arn-nasuni1.ad.ea.com\' FROM processinfo pi WHERE pi.id ='390fac8b-0685-4501-b75e-c2668779d409';
UPDATE vers SET basepath = REPLACE(basepath, 'ARN-panzura2','arn-nasuni1') FROM vers v WHERE v.id ='390fac8b-0685-4501-b75e-c2668779d409';
UPDATE format SET path = REPLACE(path COLLATE SQL_Latin1_General_CP1_CI_AS, 'arn-panzura2','arn-nasuni1') FROM format f JOIN hierarchy h ON f.id = h.id WHERE h.parentid ='390fac8b-0685-4501-b75e-c2668779d409';
-- Update for version 7b256486-fb39-488a-8087-f28679a2e3dd 
UPDATE pi SET storagepath = '\\arn-nasuni1.ad.ea.com\' FROM processinfo pi WHERE pi.id ='7b256486-fb39-488a-8087-f28679a2e3dd';
UPDATE vers SET basepath = REPLACE(basepath, 'ARN-panzura2','arn-nasuni1') FROM vers v WHERE v.id ='7b256486-fb39-488a-8087-f28679a2e3dd';
UPDATE format SET path = REPLACE(path COLLATE SQL_Latin1_General_CP1_CI_AS, 'arn-panzura2','arn-nasuni1') FROM format f JOIN hierarchy h ON f.id = h.id WHERE h.parentid ='7b256486-fb39-488a-8087-f28679a2e3dd';
-- Update for version 393c35d7-6381-4938-ae13-9b6de64f4077 
UPDATE pi SET storagepath = '\\arn-nasuni1.ad.ea.com\' FROM processinfo pi WHERE pi.id ='393c35d7-6381-4938-ae13-9b6de64f4077';
UPDATE vers SET basepath = REPLACE(basepath, 'ARN-panzura2','arn-nasuni1') FROM vers v WHERE v.id ='393c35d7-6381-4938-ae13-9b6de64f4077';
UPDATE format SET path = REPLACE(path COLLATE SQL_Latin1_General_CP1_CI_AS, 'arn-panzura2','arn-nasuni1') FROM format f JOIN hierarchy h ON f.id = h.id WHERE h.parentid ='393c35d7-6381-4938-ae13-9b6de64f4077';
-- Update for version f203427d-188f-483a-ab9c-930f715481cf 
UPDATE pi SET storagepath = '\\arn-nasuni1.ad.ea.com\' FROM processinfo pi WHERE pi.id ='f203427d-188f-483a-ab9c-930f715481cf';
UPDATE vers SET basepath = REPLACE(basepath, 'ARN-panzura2','arn-nasuni1') FROM vers v WHERE v.id ='f203427d-188f-483a-ab9c-930f715481cf';
UPDATE format SET path = REPLACE(path COLLATE SQL_Latin1_General_CP1_CI_AS, 'arn-panzura2','arn-nasuni1') FROM format f JOIN hierarchy h ON f.id = h.id WHERE h.parentid ='f203427d-188f-483a-ab9c-930f715481cf';
-- Update for version 8c6b8fbf-7328-42b6-9e0b-347f6a460092 
UPDATE pi SET storagepath = '\\arn-nasuni1.ad.ea.com\' FROM processinfo pi WHERE pi.id ='8c6b8fbf-7328-42b6-9e0b-347f6a460092';
UPDATE vers SET basepath = REPLACE(basepath, 'ARN-panzura2','arn-nasuni1') FROM vers v WHERE v.id ='8c6b8fbf-7328-42b6-9e0b-347f6a460092';
UPDATE format SET path = REPLACE(path COLLATE SQL_Latin1_General_CP1_CI_AS, 'arn-panzura2','arn-nasuni1') FROM format f JOIN hierarchy h ON f.id = h.id WHERE h.parentid ='8c6b8fbf-7328-42b6-9e0b-347f6a460092';
-- Update for version 637568cd-f0d1-4f3f-8b3a-c8edac7ecf9a 
UPDATE pi SET storagepath = '\\arn-nasuni1.ad.ea.com\' FROM processinfo pi WHERE pi.id ='637568cd-f0d1-4f3f-8b3a-c8edac7ecf9a';
UPDATE vers SET basepath = REPLACE(basepath, 'ARN-panzura2','arn-nasuni1') FROM vers v WHERE v.id ='637568cd-f0d1-4f3f-8b3a-c8edac7ecf9a';
UPDATE format SET path = REPLACE(path COLLATE SQL_Latin1_General_CP1_CI_AS, 'arn-panzura2','arn-nasuni1') FROM format f JOIN hierarchy h ON f.id = h.id WHERE h.parentid ='637568cd-f0d1-4f3f-8b3a-c8edac7ecf9a';
-- Update for version 944b2552-d440-43a5-b134-50fe1d16f0ce 
UPDATE pi SET storagepath = '\\arn-nasuni1.ad.ea.com\' FROM processinfo pi WHERE pi.id ='944b2552-d440-43a5-b134-50fe1d16f0ce';
UPDATE vers SET basepath = REPLACE(basepath, 'ARN-panzura2','arn-nasuni1') FROM vers v WHERE v.id ='944b2552-d440-43a5-b134-50fe1d16f0ce';
UPDATE format SET path = REPLACE(path COLLATE SQL_Latin1_General_CP1_CI_AS, 'arn-panzura2','arn-nasuni1') FROM format f JOIN hierarchy h ON f.id = h.id WHERE h.parentid ='944b2552-d440-43a5-b134-50fe1d16f0ce';
-- Update for version 7de33f93-35d3-4d28-b5f5-0cfc989fadca 
UPDATE pi SET storagepath = '\\arn-nasuni1.ad.ea.com\' FROM processinfo pi WHERE pi.id ='7de33f93-35d3-4d28-b5f5-0cfc989fadca';
UPDATE vers SET basepath = REPLACE(basepath, 'ARN-panzura2','arn-nasuni1') FROM vers v WHERE v.id ='7de33f93-35d3-4d28-b5f5-0cfc989fadca';
UPDATE format SET path = REPLACE(path COLLATE SQL_Latin1_General_CP1_CI_AS, 'arn-panzura2','arn-nasuni1') FROM format f JOIN hierarchy h ON f.id = h.id WHERE h.parentid ='7de33f93-35d3-4d28-b5f5-0cfc989fadca';
-- Update for version 97845d10-af1a-4d51-80ad-0c45453ef7a6 
UPDATE pi SET storagepath = '\\arn-nasuni1.ad.ea.com\' FROM processinfo pi WHERE pi.id ='97845d10-af1a-4d51-80ad-0c45453ef7a6';
UPDATE vers SET basepath = REPLACE(basepath, 'ARN-panzura2','arn-nasuni1') FROM vers v WHERE v.id ='97845d10-af1a-4d51-80ad-0c45453ef7a6';
UPDATE format SET path = REPLACE(path COLLATE SQL_Latin1_General_CP1_CI_AS, 'arn-panzura2','arn-nasuni1') FROM format f JOIN hierarchy h ON f.id = h.id WHERE h.parentid ='97845d10-af1a-4d51-80ad-0c45453ef7a6';
...
UPDATE pi SET storagepath = '\\arn-nasuni1.ad.ea.com\' FROM processinfo pi WHERE pi.id ='e3774f05-c41e-457c-aab0-5b173c6c8f39';
UPDATE vers SET basepath = REPLACE(basepath, 'ARN-panzura1','arn-nasuni1') FROM vers v WHERE v.id ='e3774f05-c41e-457c-aab0-5b173c6c8f39';
UPDATE format SET path = REPLACE(path COLLATE SQL_Latin1_General_CP1_CI_AS, 'arn-panzura1','arn-nasuni1') FROM format f JOIN hierarchy h ON f.id = h.id WHERE h.parentid ='e3774f05-c41e-457c-aab0-5b173c6c8f39';
...
UPDATE pi SET storagepath = '\\arn-nasuni1.ad.ea.com\' FROM processinfo pi WHERE pi.id ='60ebbb0d-139a-4953-a180-1d2aebedf926';
UPDATE vers SET basepath = REPLACE(basepath, 'ARN-panzura1','arn-nasuni1') FROM vers v WHERE v.id ='60ebbb0d-139a-4953-a180-1d2aebedf926';
UPDATE format SET path = REPLACE(path COLLATE SQL_Latin1_General_CP1_CI_AS, 'arn-panzura1','arn-nasuni1') FROM format f JOIN hierarchy h ON f.id = h.id WHERE h.parentid ='60ebbb0d-139a-4953-a180-1d2aebedf926';
...
UPDATE pi SET storagepath = '\\arn-nasuni1.ad.ea.com\' FROM processinfo pi WHERE pi.id ='dba9bc45-bcec-408c-8cc9-224126ac333f';
UPDATE vers SET basepath = REPLACE(basepath, 'ARN-panzura2','arn-nasuni1') FROM vers v WHERE v.id ='dba9bc45-bcec-408c-8cc9-224126ac333f';
UPDATE format SET path = REPLACE(path COLLATE SQL_Latin1_General_CP1_CI_AS, 'arn-panzura2','arn-nasuni1') FROM format f JOIN hierarchy h ON f.id = h.id WHERE h.parentid ='dba9bc45-bcec-408c-8cc9-224126ac333f';
-- Update for version 7cbf71e1-90c8-421d-b1f9-42eb7db7b474 
UPDATE pi SET storagepath = '\\arn-nasuni1.ad.ea.com\' FROM processinfo pi WHERE pi.id ='7cbf71e1-90c8-421d-b1f9-42eb7db7b474';
UPDATE vers SET basepath = REPLACE(basepath, 'ARN-panzura2','arn-nasuni1') FROM vers v WHERE v.id ='7cbf71e1-90c8-421d-b1f9-42eb7db7b474';
UPDATE format SET path = REPLACE(path COLLATE SQL_Latin1_General_CP1_CI_AS, 'arn-panzura2','arn-nasuni1') FROM format f JOIN hierarchy h ON f.id = h.id WHERE h.parentid ='7cbf71e1-90c8-421d-b1f9-42eb7db7b474';
-- Update for version b1c13908-2db6-489e-b269-b212525c134e 
UPDATE pi SET storagepath = '\\arn-nasuni1.ad.ea.com\' FROM processinfo pi WHERE pi.id ='b1c13908-2db6-489e-b269-b212525c134e';
UPDATE vers SET basepath = REPLACE(basepath, 'ARN-panzura2','arn-nasuni1') FROM vers v WHERE v.id ='b1c13908-2db6-489e-b269-b212525c134e';
UPDATE format SET path = REPLACE(path COLLATE SQL_Latin1_General_CP1_CI_AS, 'arn-panzura2','arn-nasuni1') FROM format f JOIN hierarchy h ON f.id = h.id WHERE h.parentid ='b1c13908-2db6-489e-b269-b212525c134e';
-- Update for version 25f25c99-e589-4e3a-a945-f6e6976236a2 
UPDATE pi SET storagepath = '\\arn-nasuni1.ad.ea.com\' FROM processinfo pi WHERE pi.id ='25f25c99-e589-4e3a-a945-f6e6976236a2';
UPDATE vers SET basepath = REPLACE(basepath, 'ARN-panzura2','arn-nasuni1') FROM vers v WHERE v.id ='25f25c99-e589-4e3a-a945-f6e6976236a2';
UPDATE format SET path = REPLACE(path COLLATE SQL_Latin1_General_CP1_CI_AS, 'arn-panzura2','arn-nasuni1') FROM format f JOIN hierarchy h ON f.id = h.id WHERE h.parentid ='25f25c99-e589-4e3a-a945-f6e6976236a2';
...
UPDATE pi SET storagepath = '\\arn-nasuni1.ad.ea.com\' FROM processinfo pi WHERE pi.id ='61ac19cb-d081-49bc-af5b-95664252a16c';
UPDATE vers SET basepath = REPLACE(basepath, 'ARN-panzura2','arn-nasuni1') FROM vers v WHERE v.id ='61ac19cb-d081-49bc-af5b-95664252a16c';
UPDATE format SET path = REPLACE(path COLLATE SQL_Latin1_General_CP1_CI_AS, 'arn-panzura2','arn-nasuni1') FROM format f JOIN hierarchy h ON f.id = h.id WHERE h.parentid ='61ac19cb-d081-49bc-af5b-95664252a16c';
-- Update for version 0eb8bb6d-a011-486a-b785-09bcfad87770 
UPDATE pi SET storagepath = '\\arn-nasuni1.ad.ea.com\' FROM processinfo pi WHERE pi.id ='0eb8bb6d-a011-486a-b785-09bcfad87770';
UPDATE vers SET basepath = REPLACE(basepath, 'ARN-panzura2','arn-nasuni1') FROM vers v WHERE v.id ='0eb8bb6d-a011-486a-b785-09bcfad87770';
UPDATE format SET path = REPLACE(path COLLATE SQL_Latin1_General_CP1_CI_AS, 'arn-panzura2','arn-nasuni1') FROM format f JOIN hierarchy h ON f.id = h.id WHERE h.parentid ='0eb8bb6d-a011-486a-b785-09bcfad87770';
-- Update for version df992776-fe2f-4f02-8bec-f0f74c3bf531 
UPDATE pi SET storagepath = '\\arn-nasuni1.ad.ea.com\' FROM processinfo pi WHERE pi.id ='df992776-fe2f-4f02-8bec-f0f74c3bf531';
UPDATE vers SET basepath = REPLACE(basepath, 'ARN-panzura2','arn-nasuni1') FROM vers v WHERE v.id ='df992776-fe2f-4f02-8bec-f0f74c3bf531';
UPDATE format SET path = REPLACE(path COLLATE SQL_Latin1_General_CP1_CI_AS, 'arn-panzura2','arn-nasuni1') FROM format f JOIN hierarchy h ON f.id = h.id WHERE h.parentid ='df992776-fe2f-4f02-8bec-f0f74c3bf531';
...
UPDATE pi SET storagepath = '\\arn-nasuni1.ad.ea.com\' FROM processinfo pi WHERE pi.id ='5e3871e0-b0e9-41f8-972d-f5c9329db7b5';
UPDATE vers SET basepath = REPLACE(basepath, 'ARN-panzura1','arn-nasuni1') FROM vers v WHERE v.id ='5e3871e0-b0e9-41f8-972d-f5c9329db7b5';
UPDATE format SET path = REPLACE(path COLLATE SQL_Latin1_General_CP1_CI_AS, 'arn-panzura1','arn-nasuni1') FROM format f JOIN hierarchy h ON f.id = h.id WHERE h.parentid ='5e3871e0-b0e9-41f8-972d-f5c9329db7b5';
...
UPDATE pi SET storagepath = '\\arn-nasuni1.ad.ea.com\' FROM processinfo pi WHERE pi.id ='6b26f5ed-d41b-4917-bfa3-bac8197f3b83';
UPDATE vers SET basepath = REPLACE(basepath, 'ARN-panzura1','arn-nasuni1') FROM vers v WHERE v.id ='6b26f5ed-d41b-4917-bfa3-bac8197f3b83';
UPDATE format SET path = REPLACE(path COLLATE SQL_Latin1_General_CP1_CI_AS, 'arn-panzura1','arn-nasuni1') FROM format f JOIN hierarchy h ON f.id = h.id WHERE h.parentid ='6b26f5ed-d41b-4917-bfa3-bac8197f3b83';
-- Update for version ee91def3-6a74-4a14-ad3a-d9bf18e06c9c 
UPDATE pi SET storagepath = '\\arn-nasuni1.ad.ea.com\' FROM processinfo pi WHERE pi.id ='ee91def3-6a74-4a14-ad3a-d9bf18e06c9c';
UPDATE vers SET basepath = REPLACE(basepath, 'ARN-panzura1','arn-nasuni1') FROM vers v WHERE v.id ='ee91def3-6a74-4a14-ad3a-d9bf18e06c9c';
UPDATE format SET path = REPLACE(path COLLATE SQL_Latin1_General_CP1_CI_AS, 'arn-panzura1','arn-nasuni1') FROM format f JOIN hierarchy h ON f.id = h.id WHERE h.parentid ='ee91def3-6a74-4a14-ad3a-d9bf18e06c9c';
...
UPDATE pi SET storagepath = '\\arn-nasuni1.ad.ea.com\' FROM processinfo pi WHERE pi.id ='71911fa2-3f7a-44b4-bf64-452acf53c140';
UPDATE vers SET basepath = REPLACE(basepath, 'ARN-panzura2','arn-nasuni1') FROM vers v WHERE v.id ='71911fa2-3f7a-44b4-bf64-452acf53c140';
UPDATE format SET path = REPLACE(path COLLATE SQL_Latin1_General_CP1_CI_AS, 'arn-panzura2','arn-nasuni1') FROM format f JOIN hierarchy h ON f.id = h.id WHERE h.parentid ='71911fa2-3f7a-44b4-bf64-452acf53c140';
...
UPDATE pi SET storagepath = '\\arn-nasuni1.ad.ea.com\' FROM processinfo pi WHERE pi.id ='d0fe166f-dd50-4154-a7a7-057260ed74b8';
UPDATE vers SET basepath = REPLACE(basepath, 'ARN-panzura2','arn-nasuni1') FROM vers v WHERE v.id ='d0fe166f-dd50-4154-a7a7-057260ed74b8';
UPDATE format SET path = REPLACE(path COLLATE SQL_Latin1_General_CP1_CI_AS, 'arn-panzura2','arn-nasuni1') FROM format f JOIN hierarchy h ON f.id = h.id WHERE h.parentid ='d0fe166f-dd50-4154-a7a7-057260ed74b8';
-- Update for version 4c4b6a14-3a80-4c5b-ba08-b5b3933d4da3 
UPDATE pi SET storagepath = '\\arn-nasuni1.ad.ea.com\' FROM processinfo pi WHERE pi.id ='4c4b6a14-3a80-4c5b-ba08-b5b3933d4da3';
UPDATE vers SET basepath = REPLACE(basepath, 'ARN-panzura2','arn-nasuni1') FROM vers v WHERE v.id ='4c4b6a14-3a80-4c5b-ba08-b5b3933d4da3';
UPDATE format SET path = REPLACE(path COLLATE SQL_Latin1_General_CP1_CI_AS, 'arn-panzura2','arn-nasuni1') FROM format f JOIN hierarchy h ON f.id = h.id WHERE h.parentid ='4c4b6a14-3a80-4c5b-ba08-b5b3933d4da3';
-- Update for version 3b821fb1-85d2-417c-8c85-c1a13b268774 
UPDATE pi SET storagepath = '\\arn-nasuni1.ad.ea.com\' FROM processinfo pi WHERE pi.id ='3b821fb1-85d2-417c-8c85-c1a13b268774';
UPDATE vers SET basepath = REPLACE(basepath, 'ARN-panzura2','arn-nasuni1') FROM vers v WHERE v.id ='3b821fb1-85d2-417c-8c85-c1a13b268774';
UPDATE format SET path = REPLACE(path COLLATE SQL_Latin1_General_CP1_CI_AS, 'arn-panzura2','arn-nasuni1') FROM format f JOIN hierarchy h ON f.id = h.id WHERE h.parentid ='3b821fb1-85d2-417c-8c85-c1a13b268774';
-- Update for version 33d01730-a730-413d-bd0c-0924c766069c 
UPDATE pi SET storagepath = '\\arn-nasuni1.ad.ea.com\' FROM processinfo pi WHERE pi.id ='33d01730-a730-413d-bd0c-0924c766069c';
UPDATE vers SET basepath = REPLACE(basepath, 'ARN-panzura2','arn-nasuni1') FROM vers v WHERE v.id ='33d01730-a730-413d-bd0c-0924c766069c';
UPDATE format SET path = REPLACE(path COLLATE SQL_Latin1_General_CP1_CI_AS, 'arn-panzura2','arn-nasuni1') FROM format f JOIN hierarchy h ON f.id = h.id WHERE h.parentid ='33d01730-a730-413d-bd0c-0924c766069c';
...
UPDATE pi SET storagepath = '\\arn-nasuni1.ad.ea.com\' FROM processinfo pi WHERE pi.id ='f3320fd1-8535-4c60-b53f-3e0e8bd06afd';
UPDATE vers SET basepath = REPLACE(basepath, 'ARN-panzura2','arn-nasuni1') FROM vers v WHERE v.id ='f3320fd1-8535-4c60-b53f-3e0e8bd06afd';
UPDATE format SET path = REPLACE(path COLLATE SQL_Latin1_General_CP1_CI_AS, 'arn-panzura2','arn-nasuni1') FROM format f JOIN hierarchy h ON f.id = h.id WHERE h.parentid ='f3320fd1-8535-4c60-b53f-3e0e8bd06afd';
-- Update for version 52783b4b-fa31-49bf-869a-89b10cb5676b 
UPDATE pi SET storagepath = '\\arn-nasuni1.ad.ea.com\' FROM processinfo pi WHERE pi.id ='52783b4b-fa31-49bf-869a-89b10cb5676b';
UPDATE vers SET basepath = REPLACE(basepath, 'ARN-panzura2','arn-nasuni1') FROM vers v WHERE v.id ='52783b4b-fa31-49bf-869a-89b10cb5676b';
UPDATE format SET path = REPLACE(path COLLATE SQL_Latin1_General_CP1_CI_AS, 'arn-panzura2','arn-nasuni1') FROM format f JOIN hierarchy h ON f.id = h.id WHERE h.parentid ='52783b4b-fa31-49bf-869a-89b10cb5676b';
-- Update for version 3304db66-2e87-4c02-abdb-f6dd3e5940d1 
UPDATE pi SET storagepath = '\\arn-nasuni1.ad.ea.com\' FROM processinfo pi WHERE pi.id ='3304db66-2e87-4c02-abdb-f6dd3e5940d1';
UPDATE vers SET basepath = REPLACE(basepath, 'ARN-panzura1','arn-nasuni1') FROM vers v WHERE v.id ='3304db66-2e87-4c02-abdb-f6dd3e5940d1';
UPDATE format SET path = REPLACE(path COLLATE SQL_Latin1_General_CP1_CI_AS, 'arn-panzura1','arn-nasuni1') FROM format f JOIN hierarchy h ON f.id = h.id WHERE h.parentid ='3304db66-2e87-4c02-abdb-f6dd3e5940d1';
-- Update for version 3b8c90da-ae4d-41b4-8ea7-d65ec8023291 
UPDATE pi SET storagepath = '\\arn-nasuni1.ad.ea.com\' FROM processinfo pi WHERE pi.id ='3b8c90da-ae4d-41b4-8ea7-d65ec8023291';
UPDATE vers SET basepath = REPLACE(basepath, 'ARN-panzura1','arn-nasuni1') FROM vers v WHERE v.id ='3b8c90da-ae4d-41b4-8ea7-d65ec8023291';
UPDATE format SET path = REPLACE(path COLLATE SQL_Latin1_General_CP1_CI_AS, 'arn-panzura1','arn-nasuni1') FROM format f JOIN hierarchy h ON f.id = h.id WHERE h.parentid ='3b8c90da-ae4d-41b4-8ea7-d65ec8023291';
-- Update for version d78ab5ba-817f-48e6-b365-7303c1094a9b 
UPDATE pi SET storagepath = '\\arn-nasuni1.ad.ea.com\' FROM processinfo pi WHERE pi.id ='d78ab5ba-817f-48e6-b365-7303c1094a9b';
UPDATE vers SET basepath = REPLACE(basepath, 'ARN-panzura1','arn-nasuni1') FROM vers v WHERE v.id ='d78ab5ba-817f-48e6-b365-7303c1094a9b';
UPDATE format SET path = REPLACE(path COLLATE SQL_Latin1_General_CP1_CI_AS, 'arn-panzura1','arn-nasuni1') FROM format f JOIN hierarchy h ON f.id = h.id WHERE h.parentid ='d78ab5ba-817f-48e6-b365-7303c1094a9b';
-- Update for version aa840ea7-d7f9-4541-8a65-fe6672aba281 
UPDATE pi SET storagepath = '\\arn-nasuni1.ad.ea.com\' FROM processinfo pi WHERE pi.id ='aa840ea7-d7f9-4541-8a65-fe6672aba281';
UPDATE vers SET basepath = REPLACE(basepath, 'ARN-panzura1','arn-nasuni1') FROM vers v WHERE v.id ='aa840ea7-d7f9-4541-8a65-fe6672aba281';
UPDATE format SET path = REPLACE(path COLLATE SQL_Latin1_General_CP1_CI_AS, 'arn-panzura1','arn-nasuni1') FROM format f JOIN hierarchy h ON f.id = h.id WHERE h.parentid ='aa840ea7-d7f9-4541-8a65-fe6672aba281';
-- Update for version 3495101f-8e69-4d4f-8f7d-262917d9b5f1 
UPDATE pi SET storagepath = '\\arn-nasuni1.ad.ea.com\' FROM processinfo pi WHERE pi.id ='3495101f-8e69-4d4f-8f7d-262917d9b5f1';
UPDATE vers SET basepath = REPLACE(basepath, 'ARN-panzura1','arn-nasuni1') FROM vers v WHERE v.id ='3495101f-8e69-4d4f-8f7d-262917d9b5f1';
UPDATE format SET path = REPLACE(path COLLATE SQL_Latin1_General_CP1_CI_AS, 'arn-panzura1','arn-nasuni1') FROM format f JOIN hierarchy h ON f.id = h.id WHERE h.parentid ='3495101f-8e69-4d4f-8f7d-262917d9b5f1';
-- Update for version 91d9f9d2-9e04-4cbb-b563-f83d67209e8e 
UPDATE pi SET storagepath = '\\arn-nasuni1.ad.ea.com\' FROM processinfo pi WHERE pi.id ='91d9f9d2-9e04-4cbb-b563-f83d67209e8e';
UPDATE vers SET basepath = REPLACE(basepath, 'ARN-panzura2','arn-nasuni1') FROM vers v WHERE v.id ='91d9f9d2-9e04-4cbb-b563-f83d67209e8e';
UPDATE format SET path = REPLACE(path COLLATE SQL_Latin1_General_CP1_CI_AS, 'arn-panzura2','arn-nasuni1') FROM format f JOIN hierarchy h ON f.id = h.id WHERE h.parentid ='91d9f9d2-9e04-4cbb-b563-f83d67209e8e';
-- Update for version 71749587-a44a-48e8-8582-f2e878923d59 
UPDATE pi SET storagepath = '\\arn-nasuni1.ad.ea.com\' FROM processinfo pi WHERE pi.id ='71749587-a44a-48e8-8582-f2e878923d59';
UPDATE vers SET basepath = REPLACE(basepath, 'ARN-panzura2','arn-nasuni1') FROM vers v WHERE v.id ='71749587-a44a-48e8-8582-f2e878923d59';
UPDATE format SET path = REPLACE(path COLLATE SQL_Latin1_General_CP1_CI_AS, 'arn-panzura2','arn-nasuni1') FROM format f JOIN hierarchy h ON f.id = h.id WHERE h.parentid ='71749587-a44a-48e8-8582-f2e878923d59';
...
UPDATE pi SET storagepath = '\\arn-nasuni1.ad.ea.com\' FROM processinfo pi WHERE pi.id ='ec63da42-6eb3-4731-9be5-0ba4f1a5eb07';
UPDATE vers SET basepath = REPLACE(basepath, 'ARN-panzura2','arn-nasuni1') FROM vers v WHERE v.id ='ec63da42-6eb3-4731-9be5-0ba4f1a5eb07';
UPDATE format SET path = REPLACE(path COLLATE SQL_Latin1_General_CP1_CI_AS, 'arn-panzura2','arn-nasuni1') FROM format f JOIN hierarchy h ON f.id = h.id WHERE h.parentid ='ec63da42-6eb3-4731-9be5-0ba4f1a5eb07';
-- Update for version 9e5295aa-db3b-4fd4-bd29-1238a27609c3 
UPDATE pi SET storagepath = '\\arn-nasuni1.ad.ea.com\' FROM processinfo pi WHERE pi.id ='9e5295aa-db3b-4fd4-bd29-1238a27609c3';
UPDATE vers SET basepath = REPLACE(basepath, 'ARN-panzura2','arn-nasuni1') FROM vers v WHERE v.id ='9e5295aa-db3b-4fd4-bd29-1238a27609c3';
UPDATE format SET path = REPLACE(path COLLATE SQL_Latin1_General_CP1_CI_AS, 'arn-panzura2','arn-nasuni1') FROM format f JOIN hierarchy h ON f.id = h.id WHERE h.parentid ='9e5295aa-db3b-4fd4-bd29-1238a27609c3';
...
UPDATE pi SET storagepath = '\\arn-nasuni1.ad.ea.com\' FROM processinfo pi WHERE pi.id ='d3bb3f99-bf1c-4218-9d47-22d4c5c9c05b';
UPDATE vers SET basepath = REPLACE(basepath, 'ARN-panzura2','arn-nasuni1') FROM vers v WHERE v.id ='d3bb3f99-bf1c-4218-9d47-22d4c5c9c05b';
UPDATE format SET path = REPLACE(path COLLATE SQL_Latin1_General_CP1_CI_AS, 'arn-panzura2','arn-nasuni1') FROM format f JOIN hierarchy h ON f.id = h.id WHERE h.parentid ='d3bb3f99-bf1c-4218-9d47-22d4c5c9c05b';
