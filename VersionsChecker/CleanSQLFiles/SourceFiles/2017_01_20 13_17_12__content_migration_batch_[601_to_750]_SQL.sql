...
UPDATE pi SET storagepath = '\\arn-nasuni1.ad.ea.com\' FROM processinfo pi WHERE pi.id ='f80d0a44-02ab-4156-880c-744635734e5d';
UPDATE vers SET basepath = REPLACE(basepath, 'ARN-panzura1','arn-nasuni1') FROM vers v WHERE v.id ='f80d0a44-02ab-4156-880c-744635734e5d';
UPDATE format SET path = REPLACE(path COLLATE SQL_Latin1_General_CP1_CI_AS, 'arn-panzura1','arn-nasuni1') FROM format f JOIN hierarchy h ON f.id = h.id WHERE h.parentid ='f80d0a44-02ab-4156-880c-744635734e5d';
-- Update for version 0a23cc22-ed6c-4c59-b03e-76466f96452b 
UPDATE pi SET storagepath = '\\arn-nasuni1.ad.ea.com\' FROM processinfo pi WHERE pi.id ='0a23cc22-ed6c-4c59-b03e-76466f96452b';
UPDATE vers SET basepath = REPLACE(basepath, 'ARN-panzura1','arn-nasuni1') FROM vers v WHERE v.id ='0a23cc22-ed6c-4c59-b03e-76466f96452b';
UPDATE format SET path = REPLACE(path COLLATE SQL_Latin1_General_CP1_CI_AS, 'arn-panzura1','arn-nasuni1') FROM format f JOIN hierarchy h ON f.id = h.id WHERE h.parentid ='0a23cc22-ed6c-4c59-b03e-76466f96452b';
-- Update for version 33c008d1-82e0-4147-8be4-b0e8076b3b4a 
UPDATE pi SET storagepath = '\\arn-nasuni1.ad.ea.com\' FROM processinfo pi WHERE pi.id ='33c008d1-82e0-4147-8be4-b0e8076b3b4a';
UPDATE vers SET basepath = REPLACE(basepath, 'ARN-panzura1','arn-nasuni1') FROM vers v WHERE v.id ='33c008d1-82e0-4147-8be4-b0e8076b3b4a';
UPDATE format SET path = REPLACE(path COLLATE SQL_Latin1_General_CP1_CI_AS, 'arn-panzura1','arn-nasuni1') FROM format f JOIN hierarchy h ON f.id = h.id WHERE h.parentid ='33c008d1-82e0-4147-8be4-b0e8076b3b4a';
-- Update for version 45c671f1-55dc-4b94-9e9c-91344c47aefc 
UPDATE pi SET storagepath = '\\arn-nasuni1.ad.ea.com\' FROM processinfo pi WHERE pi.id ='45c671f1-55dc-4b94-9e9c-91344c47aefc';
UPDATE vers SET basepath = REPLACE(basepath, 'ARN-panzura1','arn-nasuni1') FROM vers v WHERE v.id ='45c671f1-55dc-4b94-9e9c-91344c47aefc';
UPDATE format SET path = REPLACE(path COLLATE SQL_Latin1_General_CP1_CI_AS, 'arn-panzura1','arn-nasuni1') FROM format f JOIN hierarchy h ON f.id = h.id WHERE h.parentid ='45c671f1-55dc-4b94-9e9c-91344c47aefc';
...
UPDATE pi SET storagepath = '\\arn-nasuni1.ad.ea.com\' FROM processinfo pi WHERE pi.id ='474ffda5-5483-43b6-bd8c-d05661862b5f';
UPDATE vers SET basepath = REPLACE(basepath, 'ARN-panzura1','arn-nasuni1') FROM vers v WHERE v.id ='474ffda5-5483-43b6-bd8c-d05661862b5f';
UPDATE format SET path = REPLACE(path COLLATE SQL_Latin1_General_CP1_CI_AS, 'arn-panzura1','arn-nasuni1') FROM format f JOIN hierarchy h ON f.id = h.id WHERE h.parentid ='474ffda5-5483-43b6-bd8c-d05661862b5f';
-- Update for version ed8c9d21-b5b7-499c-b382-a37885a0dcdb 
UPDATE pi SET storagepath = '\\arn-nasuni1.ad.ea.com\' FROM processinfo pi WHERE pi.id ='ed8c9d21-b5b7-499c-b382-a37885a0dcdb';
UPDATE vers SET basepath = REPLACE(basepath, 'ARN-panzura1','arn-nasuni1') FROM vers v WHERE v.id ='ed8c9d21-b5b7-499c-b382-a37885a0dcdb';
UPDATE format SET path = REPLACE(path COLLATE SQL_Latin1_General_CP1_CI_AS, 'arn-panzura1','arn-nasuni1') FROM format f JOIN hierarchy h ON f.id = h.id WHERE h.parentid ='ed8c9d21-b5b7-499c-b382-a37885a0dcdb';
-- Update for version 4764fa51-98cc-4398-b563-f5b6ef9b1224 
UPDATE pi SET storagepath = '\\arn-nasuni1.ad.ea.com\' FROM processinfo pi WHERE pi.id ='4764fa51-98cc-4398-b563-f5b6ef9b1224';
UPDATE vers SET basepath = REPLACE(basepath, 'ARN-panzura1','arn-nasuni1') FROM vers v WHERE v.id ='4764fa51-98cc-4398-b563-f5b6ef9b1224';
UPDATE format SET path = REPLACE(path COLLATE SQL_Latin1_General_CP1_CI_AS, 'arn-panzura1','arn-nasuni1') FROM format f JOIN hierarchy h ON f.id = h.id WHERE h.parentid ='4764fa51-98cc-4398-b563-f5b6ef9b1224';
-- Update for version 246e631d-5173-4f71-9899-5224429401c1 
UPDATE pi SET storagepath = '\\arn-nasuni1.ad.ea.com\' FROM processinfo pi WHERE pi.id ='246e631d-5173-4f71-9899-5224429401c1';
UPDATE vers SET basepath = REPLACE(basepath, 'ARN-panzura1','arn-nasuni1') FROM vers v WHERE v.id ='246e631d-5173-4f71-9899-5224429401c1';
UPDATE format SET path = REPLACE(path COLLATE SQL_Latin1_General_CP1_CI_AS, 'arn-panzura1','arn-nasuni1') FROM format f JOIN hierarchy h ON f.id = h.id WHERE h.parentid ='246e631d-5173-4f71-9899-5224429401c1';
-- Update for version b27b7cba-cc0d-4407-b191-b83c58a46e6e 
UPDATE pi SET storagepath = '\\arn-nasuni1.ad.ea.com\' FROM processinfo pi WHERE pi.id ='b27b7cba-cc0d-4407-b191-b83c58a46e6e';
UPDATE vers SET basepath = REPLACE(basepath, 'ARN-panzura1','arn-nasuni1') FROM vers v WHERE v.id ='b27b7cba-cc0d-4407-b191-b83c58a46e6e';
UPDATE format SET path = REPLACE(path COLLATE SQL_Latin1_General_CP1_CI_AS, 'arn-panzura1','arn-nasuni1') FROM format f JOIN hierarchy h ON f.id = h.id WHERE h.parentid ='b27b7cba-cc0d-4407-b191-b83c58a46e6e';
-- Update for version de2677f6-eb90-4d48-990d-cf03356b321d 
UPDATE pi SET storagepath = '\\arn-nasuni1.ad.ea.com\' FROM processinfo pi WHERE pi.id ='de2677f6-eb90-4d48-990d-cf03356b321d';
UPDATE vers SET basepath = REPLACE(basepath, 'ARN-panzura1','arn-nasuni1') FROM vers v WHERE v.id ='de2677f6-eb90-4d48-990d-cf03356b321d';
UPDATE format SET path = REPLACE(path COLLATE SQL_Latin1_General_CP1_CI_AS, 'arn-panzura1','arn-nasuni1') FROM format f JOIN hierarchy h ON f.id = h.id WHERE h.parentid ='de2677f6-eb90-4d48-990d-cf03356b321d';
...
UPDATE pi SET storagepath = '\\arn-nasuni1.ad.ea.com\' FROM processinfo pi WHERE pi.id ='925956b4-a67c-48f9-ab66-26c27475fcac';
UPDATE vers SET basepath = REPLACE(basepath, 'ARN-panzura2','arn-nasuni1') FROM vers v WHERE v.id ='925956b4-a67c-48f9-ab66-26c27475fcac';
UPDATE format SET path = REPLACE(path COLLATE SQL_Latin1_General_CP1_CI_AS, 'arn-panzura2','arn-nasuni1') FROM format f JOIN hierarchy h ON f.id = h.id WHERE h.parentid ='925956b4-a67c-48f9-ab66-26c27475fcac';
-- Update for version 5b4d283c-3a37-4e41-b0ee-fb9a6c6d46c6 
UPDATE pi SET storagepath = '\\arn-nasuni1.ad.ea.com\' FROM processinfo pi WHERE pi.id ='5b4d283c-3a37-4e41-b0ee-fb9a6c6d46c6';
UPDATE vers SET basepath = REPLACE(basepath, 'ARN-panzura2','arn-nasuni1') FROM vers v WHERE v.id ='5b4d283c-3a37-4e41-b0ee-fb9a6c6d46c6';
UPDATE format SET path = REPLACE(path COLLATE SQL_Latin1_General_CP1_CI_AS, 'arn-panzura2','arn-nasuni1') FROM format f JOIN hierarchy h ON f.id = h.id WHERE h.parentid ='5b4d283c-3a37-4e41-b0ee-fb9a6c6d46c6';
-- Update for version 94413a26-a5c5-4e04-ac9f-7a92f2006180 
UPDATE pi SET storagepath = '\\arn-nasuni1.ad.ea.com\' FROM processinfo pi WHERE pi.id ='94413a26-a5c5-4e04-ac9f-7a92f2006180';
UPDATE vers SET basepath = REPLACE(basepath, 'ARN-panzura2','arn-nasuni1') FROM vers v WHERE v.id ='94413a26-a5c5-4e04-ac9f-7a92f2006180';
UPDATE format SET path = REPLACE(path COLLATE SQL_Latin1_General_CP1_CI_AS, 'arn-panzura2','arn-nasuni1') FROM format f JOIN hierarchy h ON f.id = h.id WHERE h.parentid ='94413a26-a5c5-4e04-ac9f-7a92f2006180';
-- Update for version 8737a790-76e7-4f86-9e65-6c283292e5ee 
UPDATE pi SET storagepath = '\\arn-nasuni1.ad.ea.com\' FROM processinfo pi WHERE pi.id ='8737a790-76e7-4f86-9e65-6c283292e5ee';
UPDATE vers SET basepath = REPLACE(basepath, 'ARN-panzura2','arn-nasuni1') FROM vers v WHERE v.id ='8737a790-76e7-4f86-9e65-6c283292e5ee';
UPDATE format SET path = REPLACE(path COLLATE SQL_Latin1_General_CP1_CI_AS, 'arn-panzura2','arn-nasuni1') FROM format f JOIN hierarchy h ON f.id = h.id WHERE h.parentid ='8737a790-76e7-4f86-9e65-6c283292e5ee';
-- Update for version c2c476c6-6f73-436b-a316-a0b551bedac0 
UPDATE pi SET storagepath = '\\arn-nasuni1.ad.ea.com\' FROM processinfo pi WHERE pi.id ='c2c476c6-6f73-436b-a316-a0b551bedac0';
UPDATE vers SET basepath = REPLACE(basepath, 'ARN-panzura2','arn-nasuni1') FROM vers v WHERE v.id ='c2c476c6-6f73-436b-a316-a0b551bedac0';
UPDATE format SET path = REPLACE(path COLLATE SQL_Latin1_General_CP1_CI_AS, 'arn-panzura2','arn-nasuni1') FROM format f JOIN hierarchy h ON f.id = h.id WHERE h.parentid ='c2c476c6-6f73-436b-a316-a0b551bedac0';
...
UPDATE pi SET storagepath = '\\arn-nasuni1.ad.ea.com\' FROM processinfo pi WHERE pi.id ='8de00c65-3f6c-44d8-9894-a060b4b3090a';
UPDATE vers SET basepath = REPLACE(basepath, 'ARN-panzura2','arn-nasuni1') FROM vers v WHERE v.id ='8de00c65-3f6c-44d8-9894-a060b4b3090a';
UPDATE format SET path = REPLACE(path COLLATE SQL_Latin1_General_CP1_CI_AS, 'arn-panzura2','arn-nasuni1') FROM format f JOIN hierarchy h ON f.id = h.id WHERE h.parentid ='8de00c65-3f6c-44d8-9894-a060b4b3090a';
-- Update for version fa29466d-3565-4f96-9a1f-c21736988ed3 
UPDATE pi SET storagepath = '\\arn-nasuni1.ad.ea.com\' FROM processinfo pi WHERE pi.id ='fa29466d-3565-4f96-9a1f-c21736988ed3';
UPDATE vers SET basepath = REPLACE(basepath, 'ARN-panzura2','arn-nasuni1') FROM vers v WHERE v.id ='fa29466d-3565-4f96-9a1f-c21736988ed3';
UPDATE format SET path = REPLACE(path COLLATE SQL_Latin1_General_CP1_CI_AS, 'arn-panzura2','arn-nasuni1') FROM format f JOIN hierarchy h ON f.id = h.id WHERE h.parentid ='fa29466d-3565-4f96-9a1f-c21736988ed3';
...
UPDATE pi SET storagepath = '\\arn-nasuni1.ad.ea.com\' FROM processinfo pi WHERE pi.id ='81b53626-6a91-4608-889e-109bcfec49c1';
UPDATE vers SET basepath = REPLACE(basepath, 'ARN-panzura1','arn-nasuni1') FROM vers v WHERE v.id ='81b53626-6a91-4608-889e-109bcfec49c1';
UPDATE format SET path = REPLACE(path COLLATE SQL_Latin1_General_CP1_CI_AS, 'arn-panzura1','arn-nasuni1') FROM format f JOIN hierarchy h ON f.id = h.id WHERE h.parentid ='81b53626-6a91-4608-889e-109bcfec49c1';
-- Update for version 6981ebcd-aced-488e-abcf-00695aec6c62 
UPDATE pi SET storagepath = '\\arn-nasuni1.ad.ea.com\' FROM processinfo pi WHERE pi.id ='6981ebcd-aced-488e-abcf-00695aec6c62';
UPDATE vers SET basepath = REPLACE(basepath, 'ARN-panzura1','arn-nasuni1') FROM vers v WHERE v.id ='6981ebcd-aced-488e-abcf-00695aec6c62';
UPDATE format SET path = REPLACE(path COLLATE SQL_Latin1_General_CP1_CI_AS, 'arn-panzura1','arn-nasuni1') FROM format f JOIN hierarchy h ON f.id = h.id WHERE h.parentid ='6981ebcd-aced-488e-abcf-00695aec6c62';
-- Update for version a3288bf1-7c72-41de-98bb-c8ff9f1d5d78 
UPDATE pi SET storagepath = '\\arn-nasuni1.ad.ea.com\' FROM processinfo pi WHERE pi.id ='a3288bf1-7c72-41de-98bb-c8ff9f1d5d78';
UPDATE vers SET basepath = REPLACE(basepath, 'ARN-panzura1','arn-nasuni1') FROM vers v WHERE v.id ='a3288bf1-7c72-41de-98bb-c8ff9f1d5d78';
UPDATE format SET path = REPLACE(path COLLATE SQL_Latin1_General_CP1_CI_AS, 'arn-panzura1','arn-nasuni1') FROM format f JOIN hierarchy h ON f.id = h.id WHERE h.parentid ='a3288bf1-7c72-41de-98bb-c8ff9f1d5d78';
-- Update for version 6917ca7c-0e78-42cd-acf2-ffb50254dd93 
UPDATE pi SET storagepath = '\\arn-nasuni1.ad.ea.com\' FROM processinfo pi WHERE pi.id ='6917ca7c-0e78-42cd-acf2-ffb50254dd93';
UPDATE vers SET basepath = REPLACE(basepath, 'ARN-panzura1','arn-nasuni1') FROM vers v WHERE v.id ='6917ca7c-0e78-42cd-acf2-ffb50254dd93';
UPDATE format SET path = REPLACE(path COLLATE SQL_Latin1_General_CP1_CI_AS, 'arn-panzura1','arn-nasuni1') FROM format f JOIN hierarchy h ON f.id = h.id WHERE h.parentid ='6917ca7c-0e78-42cd-acf2-ffb50254dd93';
-- Update for version 9a4e9ebc-7e22-48cc-91ce-d40d478225c1 
UPDATE pi SET storagepath = '\\arn-nasuni1.ad.ea.com\' FROM processinfo pi WHERE pi.id ='9a4e9ebc-7e22-48cc-91ce-d40d478225c1';
UPDATE vers SET basepath = REPLACE(basepath, 'ARN-panzura1','arn-nasuni1') FROM vers v WHERE v.id ='9a4e9ebc-7e22-48cc-91ce-d40d478225c1';
UPDATE format SET path = REPLACE(path COLLATE SQL_Latin1_General_CP1_CI_AS, 'arn-panzura1','arn-nasuni1') FROM format f JOIN hierarchy h ON f.id = h.id WHERE h.parentid ='9a4e9ebc-7e22-48cc-91ce-d40d478225c1';
-- Update for version 9097ea93-fac9-47c5-8d05-ee18fc1eeebb 
UPDATE pi SET storagepath = '\\arn-nasuni1.ad.ea.com\' FROM processinfo pi WHERE pi.id ='9097ea93-fac9-47c5-8d05-ee18fc1eeebb';
UPDATE vers SET basepath = REPLACE(basepath, 'ARN-panzura1','arn-nasuni1') FROM vers v WHERE v.id ='9097ea93-fac9-47c5-8d05-ee18fc1eeebb';
UPDATE format SET path = REPLACE(path COLLATE SQL_Latin1_General_CP1_CI_AS, 'arn-panzura1','arn-nasuni1') FROM format f JOIN hierarchy h ON f.id = h.id WHERE h.parentid ='9097ea93-fac9-47c5-8d05-ee18fc1eeebb';
-- Update for version dcf439c9-ecc6-4e09-a4c5-696763750f8c 
UPDATE pi SET storagepath = '\\arn-nasuni1.ad.ea.com\' FROM processinfo pi WHERE pi.id ='dcf439c9-ecc6-4e09-a4c5-696763750f8c';
UPDATE vers SET basepath = REPLACE(basepath, 'ARN-panzura1','arn-nasuni1') FROM vers v WHERE v.id ='dcf439c9-ecc6-4e09-a4c5-696763750f8c';
UPDATE format SET path = REPLACE(path COLLATE SQL_Latin1_General_CP1_CI_AS, 'arn-panzura1','arn-nasuni1') FROM format f JOIN hierarchy h ON f.id = h.id WHERE h.parentid ='dcf439c9-ecc6-4e09-a4c5-696763750f8c';
-- Update for version 1db6eda2-fc88-4966-a1e9-84e6035b2af3 
UPDATE pi SET storagepath = '\\arn-nasuni1.ad.ea.com\' FROM processinfo pi WHERE pi.id ='1db6eda2-fc88-4966-a1e9-84e6035b2af3';
UPDATE vers SET basepath = REPLACE(basepath, 'ARN-panzura1','arn-nasuni1') FROM vers v WHERE v.id ='1db6eda2-fc88-4966-a1e9-84e6035b2af3';
UPDATE format SET path = REPLACE(path COLLATE SQL_Latin1_General_CP1_CI_AS, 'arn-panzura1','arn-nasuni1') FROM format f JOIN hierarchy h ON f.id = h.id WHERE h.parentid ='1db6eda2-fc88-4966-a1e9-84e6035b2af3';
...
UPDATE pi SET storagepath = '\\arn-nasuni1.ad.ea.com\' FROM processinfo pi WHERE pi.id ='ce5ff4c0-7148-4a6d-a221-df284d8125bc';
UPDATE vers SET basepath = REPLACE(basepath, 'ARN-panzura2','arn-nasuni1') FROM vers v WHERE v.id ='ce5ff4c0-7148-4a6d-a221-df284d8125bc';
UPDATE format SET path = REPLACE(path COLLATE SQL_Latin1_General_CP1_CI_AS, 'arn-panzura2','arn-nasuni1') FROM format f JOIN hierarchy h ON f.id = h.id WHERE h.parentid ='ce5ff4c0-7148-4a6d-a221-df284d8125bc';
-- Update for version 6a5bafcc-f214-414e-bc1b-be6116cd3040 
UPDATE pi SET storagepath = '\\arn-nasuni1.ad.ea.com\' FROM processinfo pi WHERE pi.id ='6a5bafcc-f214-414e-bc1b-be6116cd3040';
UPDATE vers SET basepath = REPLACE(basepath, 'ARN-panzura2','arn-nasuni1') FROM vers v WHERE v.id ='6a5bafcc-f214-414e-bc1b-be6116cd3040';
UPDATE format SET path = REPLACE(path COLLATE SQL_Latin1_General_CP1_CI_AS, 'arn-panzura2','arn-nasuni1') FROM format f JOIN hierarchy h ON f.id = h.id WHERE h.parentid ='6a5bafcc-f214-414e-bc1b-be6116cd3040';
...
UPDATE pi SET storagepath = '\\arn-nasuni1.ad.ea.com\' FROM processinfo pi WHERE pi.id ='afcc086d-74a9-4018-b3d2-63b3c46fefc1';
UPDATE vers SET basepath = REPLACE(basepath, 'ARN-panzura2','arn-nasuni1') FROM vers v WHERE v.id ='afcc086d-74a9-4018-b3d2-63b3c46fefc1';
UPDATE format SET path = REPLACE(path COLLATE SQL_Latin1_General_CP1_CI_AS, 'arn-panzura2','arn-nasuni1') FROM format f JOIN hierarchy h ON f.id = h.id WHERE h.parentid ='afcc086d-74a9-4018-b3d2-63b3c46fefc1';
-- Update for version b24da438-54d8-4792-9b4a-28d5f5af965f 
UPDATE pi SET storagepath = '\\arn-nasuni1.ad.ea.com\' FROM processinfo pi WHERE pi.id ='b24da438-54d8-4792-9b4a-28d5f5af965f';
UPDATE vers SET basepath = REPLACE(basepath, 'ARN-panzura2','arn-nasuni1') FROM vers v WHERE v.id ='b24da438-54d8-4792-9b4a-28d5f5af965f';
UPDATE format SET path = REPLACE(path COLLATE SQL_Latin1_General_CP1_CI_AS, 'arn-panzura2','arn-nasuni1') FROM format f JOIN hierarchy h ON f.id = h.id WHERE h.parentid ='b24da438-54d8-4792-9b4a-28d5f5af965f';
-- Update for version 687b2e2c-89e4-47d5-8da5-cc6f08d7661e 
UPDATE pi SET storagepath = '\\arn-nasuni1.ad.ea.com\' FROM processinfo pi WHERE pi.id ='687b2e2c-89e4-47d5-8da5-cc6f08d7661e';
UPDATE vers SET basepath = REPLACE(basepath, 'ARN-panzura2','arn-nasuni1') FROM vers v WHERE v.id ='687b2e2c-89e4-47d5-8da5-cc6f08d7661e';
UPDATE format SET path = REPLACE(path COLLATE SQL_Latin1_General_CP1_CI_AS, 'arn-panzura2','arn-nasuni1') FROM format f JOIN hierarchy h ON f.id = h.id WHERE h.parentid ='687b2e2c-89e4-47d5-8da5-cc6f08d7661e';
...
UPDATE pi SET storagepath = '\\arn-nasuni1.ad.ea.com\' FROM processinfo pi WHERE pi.id ='7a964f71-798e-4807-a402-ca4534b3ad49';
UPDATE vers SET basepath = REPLACE(basepath, 'ARN-panzura2','arn-nasuni1') FROM vers v WHERE v.id ='7a964f71-798e-4807-a402-ca4534b3ad49';
UPDATE format SET path = REPLACE(path COLLATE SQL_Latin1_General_CP1_CI_AS, 'arn-panzura2','arn-nasuni1') FROM format f JOIN hierarchy h ON f.id = h.id WHERE h.parentid ='7a964f71-798e-4807-a402-ca4534b3ad49';
-- Update for version ae73a5e7-87c8-4fbf-9799-088b07c2f24c 
UPDATE pi SET storagepath = '\\arn-nasuni1.ad.ea.com\' FROM processinfo pi WHERE pi.id ='ae73a5e7-87c8-4fbf-9799-088b07c2f24c';
UPDATE vers SET basepath = REPLACE(basepath, 'ARN-panzura1','arn-nasuni1') FROM vers v WHERE v.id ='ae73a5e7-87c8-4fbf-9799-088b07c2f24c';
UPDATE format SET path = REPLACE(path COLLATE SQL_Latin1_General_CP1_CI_AS, 'arn-panzura1','arn-nasuni1') FROM format f JOIN hierarchy h ON f.id = h.id WHERE h.parentid ='ae73a5e7-87c8-4fbf-9799-088b07c2f24c';
-- Update for version 7f8b47b3-a260-4169-9aad-464934b1d44a 
UPDATE pi SET storagepath = '\\arn-nasuni1.ad.ea.com\' FROM processinfo pi WHERE pi.id ='7f8b47b3-a260-4169-9aad-464934b1d44a';
UPDATE vers SET basepath = REPLACE(basepath, 'ARN-panzura1','arn-nasuni1') FROM vers v WHERE v.id ='7f8b47b3-a260-4169-9aad-464934b1d44a';
UPDATE format SET path = REPLACE(path COLLATE SQL_Latin1_General_CP1_CI_AS, 'arn-panzura1','arn-nasuni1') FROM format f JOIN hierarchy h ON f.id = h.id WHERE h.parentid ='7f8b47b3-a260-4169-9aad-464934b1d44a';
...
UPDATE pi SET storagepath = '\\arn-nasuni1.ad.ea.com\' FROM processinfo pi WHERE pi.id ='31ee84dd-de14-4307-92af-5db0df2614d0';
UPDATE vers SET basepath = REPLACE(basepath, 'ARN-panzura1','arn-nasuni1') FROM vers v WHERE v.id ='31ee84dd-de14-4307-92af-5db0df2614d0';
UPDATE format SET path = REPLACE(path COLLATE SQL_Latin1_General_CP1_CI_AS, 'arn-panzura1','arn-nasuni1') FROM format f JOIN hierarchy h ON f.id = h.id WHERE h.parentid ='31ee84dd-de14-4307-92af-5db0df2614d0';
...
UPDATE pi SET storagepath = '\\arn-nasuni1.ad.ea.com\' FROM processinfo pi WHERE pi.id ='05830d0c-710d-4818-a639-eb6a5d22d7cb';
UPDATE vers SET basepath = REPLACE(basepath, 'ARN-panzura1','arn-nasuni1') FROM vers v WHERE v.id ='05830d0c-710d-4818-a639-eb6a5d22d7cb';
UPDATE format SET path = REPLACE(path COLLATE SQL_Latin1_General_CP1_CI_AS, 'arn-panzura1','arn-nasuni1') FROM format f JOIN hierarchy h ON f.id = h.id WHERE h.parentid ='05830d0c-710d-4818-a639-eb6a5d22d7cb';
-- Update for version ae08d9af-ea2b-48e5-856e-bf6c550e17d4 
UPDATE pi SET storagepath = '\\arn-nasuni1.ad.ea.com\' FROM processinfo pi WHERE pi.id ='ae08d9af-ea2b-48e5-856e-bf6c550e17d4';
UPDATE vers SET basepath = REPLACE(basepath, 'ARN-panzura2','arn-nasuni1') FROM vers v WHERE v.id ='ae08d9af-ea2b-48e5-856e-bf6c550e17d4';
UPDATE format SET path = REPLACE(path COLLATE SQL_Latin1_General_CP1_CI_AS, 'arn-panzura2','arn-nasuni1') FROM format f JOIN hierarchy h ON f.id = h.id WHERE h.parentid ='ae08d9af-ea2b-48e5-856e-bf6c550e17d4';
-- Update for version 152cf18d-56d1-473b-90f7-f96b53565016 
UPDATE pi SET storagepath = '\\arn-nasuni1.ad.ea.com\' FROM processinfo pi WHERE pi.id ='152cf18d-56d1-473b-90f7-f96b53565016';
UPDATE vers SET basepath = REPLACE(basepath, 'ARN-panzura2','arn-nasuni1') FROM vers v WHERE v.id ='152cf18d-56d1-473b-90f7-f96b53565016';
UPDATE format SET path = REPLACE(path COLLATE SQL_Latin1_General_CP1_CI_AS, 'arn-panzura2','arn-nasuni1') FROM format f JOIN hierarchy h ON f.id = h.id WHERE h.parentid ='152cf18d-56d1-473b-90f7-f96b53565016';
-- Update for version 75bbe611-02e1-4bc4-ab47-d7de5f4fd543 
UPDATE pi SET storagepath = '\\arn-nasuni1.ad.ea.com\' FROM processinfo pi WHERE pi.id ='75bbe611-02e1-4bc4-ab47-d7de5f4fd543';
UPDATE vers SET basepath = REPLACE(basepath, 'ARN-panzura2','arn-nasuni1') FROM vers v WHERE v.id ='75bbe611-02e1-4bc4-ab47-d7de5f4fd543';
UPDATE format SET path = REPLACE(path COLLATE SQL_Latin1_General_CP1_CI_AS, 'arn-panzura2','arn-nasuni1') FROM format f JOIN hierarchy h ON f.id = h.id WHERE h.parentid ='75bbe611-02e1-4bc4-ab47-d7de5f4fd543';
-- Update for version d220ff3d-0a48-4151-849d-ea073fb1d9d8 
UPDATE pi SET storagepath = '\\arn-nasuni1.ad.ea.com\' FROM processinfo pi WHERE pi.id ='d220ff3d-0a48-4151-849d-ea073fb1d9d8';
UPDATE vers SET basepath = REPLACE(basepath, 'ARN-panzura2','arn-nasuni1') FROM vers v WHERE v.id ='d220ff3d-0a48-4151-849d-ea073fb1d9d8';
UPDATE format SET path = REPLACE(path COLLATE SQL_Latin1_General_CP1_CI_AS, 'arn-panzura2','arn-nasuni1') FROM format f JOIN hierarchy h ON f.id = h.id WHERE h.parentid ='d220ff3d-0a48-4151-849d-ea073fb1d9d8';
...
UPDATE pi SET storagepath = '\\arn-nasuni1.ad.ea.com\' FROM processinfo pi WHERE pi.id ='d28b61b2-7737-4c48-9b9d-d36f4341d2cb';
UPDATE vers SET basepath = REPLACE(basepath, 'ARN-panzura2','arn-nasuni1') FROM vers v WHERE v.id ='d28b61b2-7737-4c48-9b9d-d36f4341d2cb';
UPDATE format SET path = REPLACE(path COLLATE SQL_Latin1_General_CP1_CI_AS, 'arn-panzura2','arn-nasuni1') FROM format f JOIN hierarchy h ON f.id = h.id WHERE h.parentid ='d28b61b2-7737-4c48-9b9d-d36f4341d2cb';
-- Update for version d76773d0-f98b-48b6-85f2-1705840df372 
UPDATE pi SET storagepath = '\\arn-nasuni1.ad.ea.com\' FROM processinfo pi WHERE pi.id ='d76773d0-f98b-48b6-85f2-1705840df372';
UPDATE vers SET basepath = REPLACE(basepath, 'ARN-panzura2','arn-nasuni1') FROM vers v WHERE v.id ='d76773d0-f98b-48b6-85f2-1705840df372';
UPDATE format SET path = REPLACE(path COLLATE SQL_Latin1_General_CP1_CI_AS, 'arn-panzura2','arn-nasuni1') FROM format f JOIN hierarchy h ON f.id = h.id WHERE h.parentid ='d76773d0-f98b-48b6-85f2-1705840df372';
...
UPDATE pi SET storagepath = '\\arn-nasuni1.ad.ea.com\' FROM processinfo pi WHERE pi.id ='520bff31-9039-49a5-b5d1-6089260c8441';
UPDATE vers SET basepath = REPLACE(basepath, 'ARN-panzura1','arn-nasuni1') FROM vers v WHERE v.id ='520bff31-9039-49a5-b5d1-6089260c8441';
UPDATE format SET path = REPLACE(path COLLATE SQL_Latin1_General_CP1_CI_AS, 'arn-panzura1','arn-nasuni1') FROM format f JOIN hierarchy h ON f.id = h.id WHERE h.parentid ='520bff31-9039-49a5-b5d1-6089260c8441';
-- Update for version e33ef46c-4d2e-4487-8523-3b5df047fe10 
UPDATE pi SET storagepath = '\\arn-nasuni1.ad.ea.com\' FROM processinfo pi WHERE pi.id ='e33ef46c-4d2e-4487-8523-3b5df047fe10';
UPDATE vers SET basepath = REPLACE(basepath, 'ARN-panzura1','arn-nasuni1') FROM vers v WHERE v.id ='e33ef46c-4d2e-4487-8523-3b5df047fe10';
UPDATE format SET path = REPLACE(path COLLATE SQL_Latin1_General_CP1_CI_AS, 'arn-panzura1','arn-nasuni1') FROM format f JOIN hierarchy h ON f.id = h.id WHERE h.parentid ='e33ef46c-4d2e-4487-8523-3b5df047fe10';
...
UPDATE pi SET storagepath = '\\arn-nasuni1.ad.ea.com\' FROM processinfo pi WHERE pi.id ='a24eb4fd-2b22-4b7b-8393-b7c2acf0085d';
UPDATE vers SET basepath = REPLACE(basepath, 'ARN-panzura1','arn-nasuni1') FROM vers v WHERE v.id ='a24eb4fd-2b22-4b7b-8393-b7c2acf0085d';
UPDATE format SET path = REPLACE(path COLLATE SQL_Latin1_General_CP1_CI_AS, 'arn-panzura1','arn-nasuni1') FROM format f JOIN hierarchy h ON f.id = h.id WHERE h.parentid ='a24eb4fd-2b22-4b7b-8393-b7c2acf0085d';
-- Update for version f7767824-2ed0-4430-9c2d-9bac0028873a 
UPDATE pi SET storagepath = '\\arn-nasuni1.ad.ea.com\' FROM processinfo pi WHERE pi.id ='f7767824-2ed0-4430-9c2d-9bac0028873a';
UPDATE vers SET basepath = REPLACE(basepath, 'ARN-panzura1','arn-nasuni1') FROM vers v WHERE v.id ='f7767824-2ed0-4430-9c2d-9bac0028873a';
UPDATE format SET path = REPLACE(path COLLATE SQL_Latin1_General_CP1_CI_AS, 'arn-panzura1','arn-nasuni1') FROM format f JOIN hierarchy h ON f.id = h.id WHERE h.parentid ='f7767824-2ed0-4430-9c2d-9bac0028873a';
-- Update for version 1c9a2270-f268-4e2f-94df-5df4a8888138 
UPDATE pi SET storagepath = '\\arn-nasuni1.ad.ea.com\' FROM processinfo pi WHERE pi.id ='1c9a2270-f268-4e2f-94df-5df4a8888138';
UPDATE vers SET basepath = REPLACE(basepath, 'ARN-panzura1','arn-nasuni1') FROM vers v WHERE v.id ='1c9a2270-f268-4e2f-94df-5df4a8888138';
UPDATE format SET path = REPLACE(path COLLATE SQL_Latin1_General_CP1_CI_AS, 'arn-panzura1','arn-nasuni1') FROM format f JOIN hierarchy h ON f.id = h.id WHERE h.parentid ='1c9a2270-f268-4e2f-94df-5df4a8888138';
-- Update for version 7652fc1b-de32-4065-963b-24ce7785e991 
UPDATE pi SET storagepath = '\\arn-nasuni1.ad.ea.com\' FROM processinfo pi WHERE pi.id ='7652fc1b-de32-4065-963b-24ce7785e991';
UPDATE vers SET basepath = REPLACE(basepath, 'ARN-panzura1','arn-nasuni1') FROM vers v WHERE v.id ='7652fc1b-de32-4065-963b-24ce7785e991';
UPDATE format SET path = REPLACE(path COLLATE SQL_Latin1_General_CP1_CI_AS, 'arn-panzura1','arn-nasuni1') FROM format f JOIN hierarchy h ON f.id = h.id WHERE h.parentid ='7652fc1b-de32-4065-963b-24ce7785e991';
-- Update for version 42591795-2d5b-49a8-a067-e6fcb04f9880 
UPDATE pi SET storagepath = '\\arn-nasuni1.ad.ea.com\' FROM processinfo pi WHERE pi.id ='42591795-2d5b-49a8-a067-e6fcb04f9880';
UPDATE vers SET basepath = REPLACE(basepath, 'ARN-panzura1','arn-nasuni1') FROM vers v WHERE v.id ='42591795-2d5b-49a8-a067-e6fcb04f9880';
UPDATE format SET path = REPLACE(path COLLATE SQL_Latin1_General_CP1_CI_AS, 'arn-panzura1','arn-nasuni1') FROM format f JOIN hierarchy h ON f.id = h.id WHERE h.parentid ='42591795-2d5b-49a8-a067-e6fcb04f9880';
-- Update for version c9b37c56-ba15-4b1a-a69f-0868e00063c0 
UPDATE pi SET storagepath = '\\arn-nasuni1.ad.ea.com\' FROM processinfo pi WHERE pi.id ='c9b37c56-ba15-4b1a-a69f-0868e00063c0';
UPDATE vers SET basepath = REPLACE(basepath, 'ARN-panzura2','arn-nasuni1') FROM vers v WHERE v.id ='c9b37c56-ba15-4b1a-a69f-0868e00063c0';
UPDATE format SET path = REPLACE(path COLLATE SQL_Latin1_General_CP1_CI_AS, 'arn-panzura2','arn-nasuni1') FROM format f JOIN hierarchy h ON f.id = h.id WHERE h.parentid ='c9b37c56-ba15-4b1a-a69f-0868e00063c0';
-- Update for version 71345c2d-e10b-461e-90ef-5ac77d35e4b4 
UPDATE pi SET storagepath = '\\arn-nasuni1.ad.ea.com\' FROM processinfo pi WHERE pi.id ='71345c2d-e10b-461e-90ef-5ac77d35e4b4';
UPDATE vers SET basepath = REPLACE(basepath, 'ARN-panzura2','arn-nasuni1') FROM vers v WHERE v.id ='71345c2d-e10b-461e-90ef-5ac77d35e4b4';
UPDATE format SET path = REPLACE(path COLLATE SQL_Latin1_General_CP1_CI_AS, 'arn-panzura2','arn-nasuni1') FROM format f JOIN hierarchy h ON f.id = h.id WHERE h.parentid ='71345c2d-e10b-461e-90ef-5ac77d35e4b4';
...
UPDATE pi SET storagepath = '\\arn-nasuni1.ad.ea.com\' FROM processinfo pi WHERE pi.id ='bdf86c52-becf-49c9-8586-3fab4d471d40';
UPDATE vers SET basepath = REPLACE(basepath, 'ARN-panzura2','arn-nasuni1') FROM vers v WHERE v.id ='bdf86c52-becf-49c9-8586-3fab4d471d40';
UPDATE format SET path = REPLACE(path COLLATE SQL_Latin1_General_CP1_CI_AS, 'arn-panzura2','arn-nasuni1') FROM format f JOIN hierarchy h ON f.id = h.id WHERE h.parentid ='bdf86c52-becf-49c9-8586-3fab4d471d40';
...
UPDATE pi SET storagepath = '\\arn-nasuni1.ad.ea.com\' FROM processinfo pi WHERE pi.id ='3f5d3a2a-9d1a-47fa-b4df-b9f0e3be18d1';
UPDATE vers SET basepath = REPLACE(basepath, 'ARN-panzura2','arn-nasuni1') FROM vers v WHERE v.id ='3f5d3a2a-9d1a-47fa-b4df-b9f0e3be18d1';
UPDATE format SET path = REPLACE(path COLLATE SQL_Latin1_General_CP1_CI_AS, 'arn-panzura2','arn-nasuni1') FROM format f JOIN hierarchy h ON f.id = h.id WHERE h.parentid ='3f5d3a2a-9d1a-47fa-b4df-b9f0e3be18d1';
-- Update for version 52198686-64e3-4a6b-a1e4-a88eaec6befc 
UPDATE pi SET storagepath = '\\arn-nasuni1.ad.ea.com\' FROM processinfo pi WHERE pi.id ='52198686-64e3-4a6b-a1e4-a88eaec6befc';
UPDATE vers SET basepath = REPLACE(basepath, 'ARN-panzura2','arn-nasuni1') FROM vers v WHERE v.id ='52198686-64e3-4a6b-a1e4-a88eaec6befc';
UPDATE format SET path = REPLACE(path COLLATE SQL_Latin1_General_CP1_CI_AS, 'arn-panzura2','arn-nasuni1') FROM format f JOIN hierarchy h ON f.id = h.id WHERE h.parentid ='52198686-64e3-4a6b-a1e4-a88eaec6befc';
-- Update for version b58949b0-502a-492b-b165-52903d490bec 
UPDATE pi SET storagepath = '\\arn-nasuni1.ad.ea.com\' FROM processinfo pi WHERE pi.id ='b58949b0-502a-492b-b165-52903d490bec';
UPDATE vers SET basepath = REPLACE(basepath, 'ARN-panzura2','arn-nasuni1') FROM vers v WHERE v.id ='b58949b0-502a-492b-b165-52903d490bec';
UPDATE format SET path = REPLACE(path COLLATE SQL_Latin1_General_CP1_CI_AS, 'arn-panzura2','arn-nasuni1') FROM format f JOIN hierarchy h ON f.id = h.id WHERE h.parentid ='b58949b0-502a-492b-b165-52903d490bec';
-- Update for version 1e360707-8347-4451-bc8d-f3feaf79108e 
UPDATE pi SET storagepath = '\\arn-nasuni1.ad.ea.com\' FROM processinfo pi WHERE pi.id ='1e360707-8347-4451-bc8d-f3feaf79108e';
UPDATE vers SET basepath = REPLACE(basepath, 'ARN-panzura2','arn-nasuni1') FROM vers v WHERE v.id ='1e360707-8347-4451-bc8d-f3feaf79108e';
UPDATE format SET path = REPLACE(path COLLATE SQL_Latin1_General_CP1_CI_AS, 'arn-panzura2','arn-nasuni1') FROM format f JOIN hierarchy h ON f.id = h.id WHERE h.parentid ='1e360707-8347-4451-bc8d-f3feaf79108e';
-- Update for version cd84fd6f-e3c8-451c-9322-668c04c11277 
UPDATE pi SET storagepath = '\\arn-nasuni1.ad.ea.com\' FROM processinfo pi WHERE pi.id ='cd84fd6f-e3c8-451c-9322-668c04c11277';
UPDATE vers SET basepath = REPLACE(basepath, 'ARN-panzura2','arn-nasuni1') FROM vers v WHERE v.id ='cd84fd6f-e3c8-451c-9322-668c04c11277';
UPDATE format SET path = REPLACE(path COLLATE SQL_Latin1_General_CP1_CI_AS, 'arn-panzura2','arn-nasuni1') FROM format f JOIN hierarchy h ON f.id = h.id WHERE h.parentid ='cd84fd6f-e3c8-451c-9322-668c04c11277';
-- Update for version e46ec3ea-17b7-4334-91cf-93650d925d29 
UPDATE pi SET storagepath = '\\arn-nasuni1.ad.ea.com\' FROM processinfo pi WHERE pi.id ='e46ec3ea-17b7-4334-91cf-93650d925d29';
UPDATE vers SET basepath = REPLACE(basepath, 'ARN-panzura2','arn-nasuni1') FROM vers v WHERE v.id ='e46ec3ea-17b7-4334-91cf-93650d925d29';
UPDATE format SET path = REPLACE(path COLLATE SQL_Latin1_General_CP1_CI_AS, 'arn-panzura2','arn-nasuni1') FROM format f JOIN hierarchy h ON f.id = h.id WHERE h.parentid ='e46ec3ea-17b7-4334-91cf-93650d925d29';
-- Update for version ec698522-8aa1-4fa5-bc8d-6d85d7041abf 
UPDATE pi SET storagepath = '\\arn-nasuni1.ad.ea.com\' FROM processinfo pi WHERE pi.id ='ec698522-8aa1-4fa5-bc8d-6d85d7041abf';
UPDATE vers SET basepath = REPLACE(basepath, 'ARN-panzura2','arn-nasuni1') FROM vers v WHERE v.id ='ec698522-8aa1-4fa5-bc8d-6d85d7041abf';
UPDATE format SET path = REPLACE(path COLLATE SQL_Latin1_General_CP1_CI_AS, 'arn-panzura2','arn-nasuni1') FROM format f JOIN hierarchy h ON f.id = h.id WHERE h.parentid ='ec698522-8aa1-4fa5-bc8d-6d85d7041abf';
...
UPDATE pi SET storagepath = '\\arn-nasuni1.ad.ea.com\' FROM processinfo pi WHERE pi.id ='9ae880c9-368c-4c10-87a0-6b2114326e65';
UPDATE vers SET basepath = REPLACE(basepath, 'ARN-panzura1','arn-nasuni1') FROM vers v WHERE v.id ='9ae880c9-368c-4c10-87a0-6b2114326e65';
UPDATE format SET path = REPLACE(path COLLATE SQL_Latin1_General_CP1_CI_AS, 'arn-panzura1','arn-nasuni1') FROM format f JOIN hierarchy h ON f.id = h.id WHERE h.parentid ='9ae880c9-368c-4c10-87a0-6b2114326e65';
-- Update for version 4f24cd81-00bf-4f1c-877a-7a89d41ac39e 
UPDATE pi SET storagepath = '\\arn-nasuni1.ad.ea.com\' FROM processinfo pi WHERE pi.id ='4f24cd81-00bf-4f1c-877a-7a89d41ac39e';
UPDATE vers SET basepath = REPLACE(basepath, 'ARN-panzura1','arn-nasuni1') FROM vers v WHERE v.id ='4f24cd81-00bf-4f1c-877a-7a89d41ac39e';
UPDATE format SET path = REPLACE(path COLLATE SQL_Latin1_General_CP1_CI_AS, 'arn-panzura1','arn-nasuni1') FROM format f JOIN hierarchy h ON f.id = h.id WHERE h.parentid ='4f24cd81-00bf-4f1c-877a-7a89d41ac39e';
-- Update for version cdef3b38-78ca-45b7-bac5-25e2afdb33b0 
UPDATE pi SET storagepath = '\\arn-nasuni1.ad.ea.com\' FROM processinfo pi WHERE pi.id ='cdef3b38-78ca-45b7-bac5-25e2afdb33b0';
UPDATE vers SET basepath = REPLACE(basepath, 'ARN-panzura1','arn-nasuni1') FROM vers v WHERE v.id ='cdef3b38-78ca-45b7-bac5-25e2afdb33b0';
UPDATE format SET path = REPLACE(path COLLATE SQL_Latin1_General_CP1_CI_AS, 'arn-panzura1','arn-nasuni1') FROM format f JOIN hierarchy h ON f.id = h.id WHERE h.parentid ='cdef3b38-78ca-45b7-bac5-25e2afdb33b0';
-- Update for version ac9727b3-54ce-497e-95e5-8c3914cf4071 
UPDATE pi SET storagepath = '\\arn-nasuni1.ad.ea.com\' FROM processinfo pi WHERE pi.id ='ac9727b3-54ce-497e-95e5-8c3914cf4071';
UPDATE vers SET basepath = REPLACE(basepath, 'ARN-panzura1','arn-nasuni1') FROM vers v WHERE v.id ='ac9727b3-54ce-497e-95e5-8c3914cf4071';
UPDATE format SET path = REPLACE(path COLLATE SQL_Latin1_General_CP1_CI_AS, 'arn-panzura1','arn-nasuni1') FROM format f JOIN hierarchy h ON f.id = h.id WHERE h.parentid ='ac9727b3-54ce-497e-95e5-8c3914cf4071';
...
UPDATE pi SET storagepath = '\\arn-nasuni1.ad.ea.com\' FROM processinfo pi WHERE pi.id ='f802a336-31fe-4fa8-91ea-edc8bd8e2d2b';
UPDATE vers SET basepath = REPLACE(basepath, 'ARN-panzura2','arn-nasuni1') FROM vers v WHERE v.id ='f802a336-31fe-4fa8-91ea-edc8bd8e2d2b';
UPDATE format SET path = REPLACE(path COLLATE SQL_Latin1_General_CP1_CI_AS, 'arn-panzura2','arn-nasuni1') FROM format f JOIN hierarchy h ON f.id = h.id WHERE h.parentid ='f802a336-31fe-4fa8-91ea-edc8bd8e2d2b';
-- Update for version 8fb5db09-63b5-4d9f-abe7-94af6923bc95 
UPDATE pi SET storagepath = '\\arn-nasuni1.ad.ea.com\' FROM processinfo pi WHERE pi.id ='8fb5db09-63b5-4d9f-abe7-94af6923bc95';
UPDATE vers SET basepath = REPLACE(basepath, 'ARN-panzura2','arn-nasuni1') FROM vers v WHERE v.id ='8fb5db09-63b5-4d9f-abe7-94af6923bc95';
UPDATE format SET path = REPLACE(path COLLATE SQL_Latin1_General_CP1_CI_AS, 'arn-panzura2','arn-nasuni1') FROM format f JOIN hierarchy h ON f.id = h.id WHERE h.parentid ='8fb5db09-63b5-4d9f-abe7-94af6923bc95';
...
UPDATE pi SET storagepath = '\\arn-nasuni1.ad.ea.com\' FROM processinfo pi WHERE pi.id ='d798858e-c54f-4ca7-a5bf-f0788c7f4298';
UPDATE vers SET basepath = REPLACE(basepath, 'ARN-panzura2','arn-nasuni1') FROM vers v WHERE v.id ='d798858e-c54f-4ca7-a5bf-f0788c7f4298';
UPDATE format SET path = REPLACE(path COLLATE SQL_Latin1_General_CP1_CI_AS, 'arn-panzura2','arn-nasuni1') FROM format f JOIN hierarchy h ON f.id = h.id WHERE h.parentid ='d798858e-c54f-4ca7-a5bf-f0788c7f4298';
-- Update for version 86d2746e-40ec-4fa3-8b82-084beb50dbe4 
UPDATE pi SET storagepath = '\\arn-nasuni1.ad.ea.com\' FROM processinfo pi WHERE pi.id ='86d2746e-40ec-4fa3-8b82-084beb50dbe4';
UPDATE vers SET basepath = REPLACE(basepath, 'ARN-panzura2','arn-nasuni1') FROM vers v WHERE v.id ='86d2746e-40ec-4fa3-8b82-084beb50dbe4';
UPDATE format SET path = REPLACE(path COLLATE SQL_Latin1_General_CP1_CI_AS, 'arn-panzura2','arn-nasuni1') FROM format f JOIN hierarchy h ON f.id = h.id WHERE h.parentid ='86d2746e-40ec-4fa3-8b82-084beb50dbe4';
-- Update for version 0d32408b-4cdb-4d7f-87e8-8cccb03a4a43 
UPDATE pi SET storagepath = '\\arn-nasuni1.ad.ea.com\' FROM processinfo pi WHERE pi.id ='0d32408b-4cdb-4d7f-87e8-8cccb03a4a43';
UPDATE vers SET basepath = REPLACE(basepath, 'ARN-panzura2','arn-nasuni1') FROM vers v WHERE v.id ='0d32408b-4cdb-4d7f-87e8-8cccb03a4a43';
UPDATE format SET path = REPLACE(path COLLATE SQL_Latin1_General_CP1_CI_AS, 'arn-panzura2','arn-nasuni1') FROM format f JOIN hierarchy h ON f.id = h.id WHERE h.parentid ='0d32408b-4cdb-4d7f-87e8-8cccb03a4a43';
